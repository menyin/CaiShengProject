...
<div id="content">
	<!--{template header}-->
	<header class="pubtop">
		<a href="/" class="back jpFntWes"></a><a href="javascript:void(0)"  class="navBtn" id="navBtn" name="top"><i class="jpFntWes" style="display: none;"></i></a>
		<div class="cent"><p><b><!--{if $news[category]}-->{$news[category]}<!--{else}-->推荐资讯<!--{/if}--></b></p></div>
	</header>
		...
		<div class="part modLst nowJobs">
			...
			<div class="partC">
				<ul>
					<!--{loop $tuijian $k $l}-->
					<li>
						<a href="/hrnews/detail-{$l['detail_id']}.html">
							<div class="txt">
								<p><!--{if $category[$l[detail_cid]]}-->[ {$category[$l[detail_cid]]} ]<!--{/if}-->{$l['detail_title']}</p>
							</div>
						</a>
					</li>
					<!--{/loop}-->
...
<div style="display:none">
	...
	(function() {
	  ...
	  hm.src = "//hm.baidu.com/hm.js?840c494ca030ce085d9e157369fb9558";
