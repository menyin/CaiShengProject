...
<head>
	...
	<link rel="apple-touch-icon-precomposed" href="http://cdn.{ROOT_DOMAIN}/m/75x75.png" >
	<title><!--{if $title}-->{$title}_触屏版<!--{else}-->【找工作_招聘_求职】上597人才网_触屏版<!--{/if}--></title>
	...
	<script type="text/javascript" language="javascript" src="http://cdn.{ROOT_DOMAIN}/m/js/jquery-1.8.3.min.js"></script>
	<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=1dbbe490e08978e45f6b319cf9a01cc4"></script>
	<link rel="stylesheet" type="text/css" href="http://cdn.{ROOT_DOMAIN}/m/css/m_index2.css?v=20150915"/>
	<script type="text/javascript" language="javascript" src="http://cdn.{ROOT_DOMAIN}/m/js/swipe.js"></script>
</head>
<body>
	<style>
		body{background:#e8ecef;}
		/*iphone添加到桌面*/
		.u-layer-ath{background:url(http://cdn.{ROOT_DOMAIN}/m/images/ath.png) no-repeat;width:200px;height:75px;position:fixed;bottom:0;left:50%;margin-left:-100px;background-size:contain;display:none;transform:translate3D(0,0,0);transition:2s all;perspective:400px;z-index:9999;}
		...
		.newjobPop{width:100%; height:60px; background:url(http://cdn.{ROOT_DOMAIN}/m/images/newfilter02.png); overflow:hidden; position:fixed; left:0px; bottom:0px;z-index: 3}
...
<div class="zpwrap"  id="content">
	...
	<div class="j_myOperating" >
		<div class="j_boxe">
			<a href="http://{PREFIX_DOMAIN}.m.{ROOT_DOMAIN}/zhaopin/"><img src="http://cdn.{ROOT_DOMAIN}/m/images/4.2_homeIcon_5.png" /><span>职位搜索</span></a>
		</div><!--j_boxe end-->
		<div class="j_boxe">
			<a href="http://{PREFIX_DOMAIN}.m.{ROOT_DOMAIN}/person/job.html?act=join"><img src="http://cdn.{ROOT_DOMAIN}/m/images/4.2_homeIcon_2.png" /><span>投递简历</span></a>
		</div><!--j_boxe end-->
		<div class="j_boxe">
			<a href="http://{PREFIX_DOMAIN}.m.{ROOT_DOMAIN}/person/job.html?act=invite"><img src="http://cdn.{ROOT_DOMAIN}/m/images/4.2_homeIcon_512_1.png" /><span>面试邀请</span></a>
		</div><!--j_boxe end-->
		<div class="j_boxe">
			<a id="update" href="javascript:void(0);"><img src="http://cdn.{ROOT_DOMAIN}/m/images/4.2_homeIcon_3.png" /><span>刷新简历</span></a>
		</div><!--j_boxe end-->

		<div class="j_boxe">
			<a href="http://{PREFIX_DOMAIN}.m.{ROOT_DOMAIN}/person/"><img src="http://cdn.{ROOT_DOMAIN}/m/images/4.2_homeIcon_4.png" /><span>我的597</span></a>
		</div><!--j_boxe end-->
		<div class="j_boxe">
			<a href="http://{PREFIX_DOMAIN}.m.{ROOT_DOMAIN}/person/resumes.html"><img src="http://cdn.{ROOT_DOMAIN}/m/images/4.2_homeIcon_6.png" /><span>我的简历</span></a>
		</div><!--j_boxe end-->
		<div class="j_boxe">
			<a href="http://{PREFIX_DOMAIN}.m.{ROOT_DOMAIN}/person/job.html?act=favorites"><img src="http://cdn.{ROOT_DOMAIN}/m/images/4.2_homeIcon_7.png" /><span>我的收藏</span></a>
		</div><!--j_boxe end-->
		<div class="j_boxe">
			<a href="http://{PREFIX_DOMAIN}.m.{ROOT_DOMAIN}/person/job.html?act=visit"><img src="http://cdn.{ROOT_DOMAIN}/m/images/4.2_homeIcon_8.png" /><span>谁看过我</span></a>
		</div><!--j_boxe end-->
		<div class=" clear"></div>
	</div>
	...
	<div class="j_myOperating" >
		<div class="j_boxe">
			<a href="http://{PREFIX_DOMAIN}.m.{ROOT_DOMAIN}/company/resume/apply.html"><img src="http://cdn.{ROOT_DOMAIN}/m/images/4.3_homeIcon_1.png" /><span>查收简历</span></a>
		</div><!--j_boxe end-->
		<div class="j_boxe">
			<a href="http://{PREFIX_DOMAIN}.m.{ROOT_DOMAIN}/company/job/job.html?act=edit&status=3"><img src="http://cdn.{ROOT_DOMAIN}/m/images/4.3_homeIcon_2.png" /><span>发布职位</span></a>
		</div><!--j_boxe end-->
		<div class="j_boxe">
			<a href="http://{PREFIX_DOMAIN}.m.{ROOT_DOMAIN}/company/resume/searchResume.html"><img src="http://cdn.{ROOT_DOMAIN}/m/images/4.3_homeIcon_3.png" /><span>搜索简历</span></a>
		</div><!--j_boxe end-->
		<div class="j_boxe">
			<a href="http://{PREFIX_DOMAIN}.m.{ROOT_DOMAIN}/company/job/"><img src="http://cdn.{ROOT_DOMAIN}/m/images/4.3_homeIcon_4.png" /><span>职位管理</span></a>
		</div><!--j_boxe end-->

		<div class="j_boxe">
			<a href="http://{PREFIX_DOMAIN}.m.{ROOT_DOMAIN}/company/resume/invite.html"><img src="http://cdn.{ROOT_DOMAIN}/m/images/4.3_homeIcon_5.png" /><span>面试通知</span></a>
		</div><!--j_boxe end-->
		<div class="j_boxe">
			<a href="http://{PREFIX_DOMAIN}.m.{ROOT_DOMAIN}/company/resume/download.html"><img src="http://cdn.{ROOT_DOMAIN}/m/images/4.3_homeIcon_6.png" /><span>下载简历</span></a>
		</div><!--j_boxe end-->
		<div class="j_boxe">
			<a href="http://{PREFIX_DOMAIN}.m.{ROOT_DOMAIN}/company/account/info.html"><img src="http://cdn.{ROOT_DOMAIN}/m/images/4.3_homeIcon_7.png" /><span>修改资料</span></a>
		</div><!--j_boxe end-->
		<div class="j_boxe">
			<a href="http://{PREFIX_DOMAIN}.m.{ROOT_DOMAIN}/company/account/"><img src="http://cdn.{ROOT_DOMAIN}/m/images/4.3_homeIcon_8.png" /><span>账户管理</span></a>
		</div><!--j_boxe end-->
		<div class=" clear"></div>
	</div>
	<!--{/if}-->
	...
	<dl class="j_HotJobsIndustryList j_industrySubmit">
		...
		<dd>
			<a href="http://{PREFIX_DOMAIN}.m.{ROOT_DOMAIN}/zhaopin/kuiji/" class="colorC">会计</a>
		</dd>
		<dd>
			<a href="http://{PREFIX_DOMAIN}.m.{ROOT_DOMAIN}/zhaopin/siji/">司机</a>
		</dd>
		<dd>
			<a href="http://{PREFIX_DOMAIN}.m.{ROOT_DOMAIN}/zhaopin/wenyuan/">文员</a>
		</dd>
		<dd>
			<a href="http://{PREFIX_DOMAIN}.m.{ROOT_DOMAIN}/zhaopin/meigong/">美工</a>
		</dd>
		<dd>
			<a href="http://{PREFIX_DOMAIN}.m.{ROOT_DOMAIN}/zhaopin/xingzheng/">行政</a>
		</dd>
		<dd>
			<a href="http://{PREFIX_DOMAIN}.m.{ROOT_DOMAIN}/zhaopin/renshi/" class="colorC">人事</a>
		</dd>
		<dd>
	...
	<div class="top_bar" style="-webkit-transform:translate3d(0,0,0)">
		<nav>
			<ul id="top_menu2" class="top_menu2">
				<li><a href="http://{PREFIX_DOMAIN}.m.{ROOT_DOMAIN}/zhaopin/"><img src="http://cdn.{ROOT_DOMAIN}/app/images/plugmenu6.png"><label>职位搜索</label></a></li>
				<li><a href="http://{PREFIX_DOMAIN}.m.{ROOT_DOMAIN}/person/"><img src="http://cdn.{ROOT_DOMAIN}/app/images/plugmenu5.png"><label>求职管理</label></a></li>
				<li class="home"><a href="http://{PREFIX_DOMAIN}.m.{ROOT_DOMAIN}/"></a></li>
				<li><a href="http://{PREFIX_DOMAIN}.m.{ROOT_DOMAIN}/company/"><img src="http://cdn.{ROOT_DOMAIN}/app/images/plugmenu1.png"><label>招聘管理</label></a></li>
				<li><a href="qrcode:"><img src="http://cdn.{ROOT_DOMAIN}/app/images/plugmenu8.png"><label>二维码</label></a></li>
			</ul>
		</nav>
	</div>
<!--{else}-->
	<div class="home_box">
			<ul class="bottom_nav" id="botLinks">
				<li >
					<a href="javascript:void(0);" id="shareBtn"><img src="http://cdn.{ROOT_DOMAIN}/m/images/shareIco.png"/>分享</a>
				</li>
				<li>
					<a href="http://api.map.baidu.com/geocoder?address=厦门市湖里区宝远集团大厦&output=html"><img src="http://cdn.{ROOT_DOMAIN}/m/images/mapIco.png"/>地图</a>
				</li>
				<li>
		...
		<div class="version">
			<span style=" text-align:center;"><a href="http://{PREFIX_DOMAIN}.m.{ROOT_DOMAIN}/goto.html?act=m" style="padding:3px; background:#e2e2e2; border:1px solid #e1e1e1; border-radius:2px;">触屏版</a><a href="http://{PREFIX_DOMAIN}.{ROOT_DOMAIN}/?refrom=tom">电脑版</a></span><br />
			咨询电话：<a href="tel:400-810-8597" style="color:#3f74c2;"><img src="http://cdn.{ROOT_DOMAIN}/m/images/botTel.png" alt="" />400-810-8597</a><a href="http://{PREFIX_DOMAIN}.m.{ROOT_DOMAIN}/suggestion.html" style="color:#3f74c2;">意见反馈</a><br />
		...
		<li style="position:relative;">
			...
			<div id="weixinBox">
				<h3 style="text-align:left;">
					分享到微信朋友圈
					<img src="http://cdn.{ROOT_DOMAIN}/m/images/close.jpg" alt="" class="close"></h3>
		...
		<span>
			<b>
				<dl class="selBox" id="selBox">
					<dt><em id="selectEm">全文</em> <img src="http://cdn.{ROOT_DOMAIN}/m/images/change-city.png" width="9" height="9"></dt>
					<dd>
						<p data-val="1">职位</p>
						<p data-val="2">公司</p>
						<p data-val="3">全文</p>
...
<script type="text/javascript" language="javascript" src="http://cdn.{ROOT_DOMAIN}/js/wechat.js?v=1"></script>
