<!--{if $app['id']}-->
	<style type="text/css">
		...
		.top_bar .top_menu2>li.home a { height: 66px; width: 66px; margin: auto; border-radius: 60px; position: relative; top: -22px; left: 0; background: url('//cdn.{ROOT_DOMAIN}/app/images/home.png') no-repeat center center; background-size: 100% 100%; }
	...
	<div class="top_bar" style="-webkit-transform:translate3d(0,0,0)">
		<nav>
			<ul id="top_menu2" class="top_menu2">
				<li><a href="/zhaopin/"><img src="//cdn.{ROOT_DOMAIN}/app/images/plugmenu6.png"><label>职位搜索</label></a></li>
				<li><a href="/person/"><img src="//cdn.{ROOT_DOMAIN}/app/images/plugmenu5.png"><label>求职管理</label></a></li>
				<li class="home"><a href="/"></a></li>
				<li><a href="/company/"><img src="//cdn.{ROOT_DOMAIN}/app/images/plugmenu1.png"><label>招聘管理</label></a></li>
				<li><a href="qrcode:"><img src="//cdn.{ROOT_DOMAIN}/app/images/plugmenu8.png"><label>二维码</label></a>
				</li>
			</ul>
		</nav>
	</div>
...
<!--{else}-->
	<footer>
		<div class="footNav">
			<!--{if $_SESSION['uid']}-->
				<div class="l"><a href="/person/">求职中心<!-- {$_SESSION['username']} --></a>|<a href="/logout.html">退出</a>|<a href="/suggestion.html">意见反馈</a></div>
			<!--{elseif $_SESSION['cid']}-->
				<div class="l"><a href="/company/">招聘中心<!-- {$_SESSION['cname']} --></a>|<a href="/logout.html">退出</a>|<a href="/suggestion.html">意见反馈</a></div>
		...
		<!--{if (!$_SESSION['wx_com'] && !$_SESSION['wx_per'])}--><p><a href="/file/download.html">客户端</a><a href="/goto.html?act=m" class="cu">触屏版</a><a href="/goto.html?act=pc">电脑版</a></p><!--{/if}-->
		...
		<p>厦门才盛人才服务有限公司版权所有:&copy;{$curYear}</p>
	</footer>
<!--{/if}-->
...
<script type="text/javascript" language="javascript" src="//cdn.{ROOT_DOMAIN}/js/wechat.js?v=2"></script>