...
<body>
<div class="loginPop">
<div class="loginTopBg"><a href="/company/"><i class="icon-uniE6005"></i></a></a>消息</div>
</div> 
<ul class="m_joinList" style="display:none;">
	<li><a class="cur" style=" background:#ebecee; border-bottom:1px solid #ebecee;" href="javascript:;">留言</a></li>
	<li class="last"><a href="/companymessage/index">提醒</a></li>
</ul>
<div id="pageless_container" class="mRcmendListbg mFilterdListbg" style="background:#ebecee;">
	<div class="reManageBg" style="background:#fff; padding:0; margin:8px; overflow:hidden;">
		<div class="nomessage" style=" width:100%; height:251px; background:url(http://cdn.597.com/m/images/nomessage1.png) center center no-repeat;"></div>
	</div>
</div>
</body></html>