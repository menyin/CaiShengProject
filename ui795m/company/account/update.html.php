...
<style>
	...
	.openSrvBox .openTxt dl dd .photoImg{width:61px; height:76px; float:left; display:inline; background:url(http://cdn.597.com/img/common/user61_76.jpg) no-repeat;}
	...
	.renSrvBox .renTxt dl dd .photoImg{width:61px; height:76px; float:left; display:inline; background:url(http://cdn.597.com/img/common/user61_76.jpg) no-repeat;}
		...
		<dl>
			...
			<dd>
				...
				<div class="txt">
					<p>苏经理</p>
					<p></p>
							<p style="font-size: 12px; line-height: 24px;">400-810-8597</p>
