...
<body>
<!--{if $app['isNewApp']!="yes"}-->
<div class="loginPop"><div class="loginTopBg"><a href="/company/account/"><i class="icon-uniE6005"></i></a>企业认证</div></div>
<div style="padding-top: 45px;"></div>
<!--{/if}-->
<div class="reManageBg">
	<p class="cFication"><em class="icon-uniE6032"></em><span>你已通过企业认证</span></p>
	<ul class="mNotestxt mNotestxtF">
		<li>
			<span>认证日期：</span>
			<p>&nbsp;{$res[_createtime]}</p>
		</li>
