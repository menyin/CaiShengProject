...
<head>
	...
	<link rel="stylesheet" type="text/css" href="http://cdn.597.com/css/pay.css?v=20140617" />
...
*/		
		$('#submitBtn').click(function(){
			...
			if(member_money<price){
				$.message('您的金额不足! <a href="/company/account/pay.html">请点击充值！</a>',{title:'操作失败,请重新操作！'});
				return false;
			}
			$.confirm('确定升级会员服务？','升级会员服务',function(){
		...
		function modifySuccess(data){
			...
			if(data&&data.status<0){
				$.message(data.error,{title:'操作失败,请重新操作！'});
				return false;
			}
		}
		//补0函数
