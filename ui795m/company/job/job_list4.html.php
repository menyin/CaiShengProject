...
<head>
	...
	<title>被屏蔽-{$domainInfo['region_name_short']}597人才网触屏版</title>
...
<div class="loginPop">
	<div class="loginTopBg"><a href="/company/index.html"><i class="icon-uniE6005"></i></a>被屏蔽职位</div>
...
<ul class="m_joinList">
	...
	<li><a href="/company/job/index.html?status=4" class="cur">被屏蔽({$countNotCheck})</a></li>
</ul>
<form>
<div class="m_joinCont" style="background:#ebecee;">
	<!--{if $com['licenceCheck']>0}-->
		<ul>
			<!--{loop $jobs $job}-->
			<li> <a title="{$job[jname]}" class="mJoinLink01" href="/company/job/jobview.html?id={$job[_jid]}&status=4"><span>{$job[jname]}</span> <b>{$job[updateTime]}</b> </a> <a href="/company/job/job.html?act=edit&jid={$job[_jid]}&status=4" class="editBtn"> <i></i>编辑</a> <a href="/company/resume/apply.html?jid={$job[_jid]}" class="mJoinLink02"> <em class="gray">{$job[joinCount]}</em> <span>简历</span> </a> <a href="/company/job/job.html?act=edit&jid={$job[_jid]}&copy=1" class="copyBtn"><i></i> 克隆</a></li>
			<!--{/loop}-->
		</ul>
		<!--{if $num_all>0}-->
