...
<head>
	...
	<title>待发布招聘-{$domainInfo['region_name_short']}597人才网触屏版</title>
...
<div class="loginPop">
	<div class="loginTopBg"><a href="/company/index.html"><i class="icon-uniE6005"></i></a>待发布职位</div>
...
<ul class="m_joinList">
	...
	<li><a href="/company/job/index.html?status=2" class="cur">待发布({$countDownline})</a></li>
...
<div class="m_joinCont" style="background:#ebecee;">
	<!--{if $com['licenceCheck']>0}-->
		<ul>
			<!--{loop $jobs $job}-->
			<li> <a title="{$job[jname]}" class="mJoinLink01" href="/company/job/jobview.html?id={$job[_jid]}&status=2"><label class="ckb"><input type="checkbox" value="{$job[_jid]}" /></label><span>{$job[jname]}</span> <b>{$job[updateTime]}</b> </a>  <a href="/company/job/job.html?act=edit&jid={$job[_jid]}&status=2" class="editBtn"><i></i> 编辑</a> <a href="/company/resume/apply.html?jid={$job[_jid]}&status=2" class="mJoinLink02"> <em class="gray">{$job[joinCount]}</em> <span>简历</span> </a> <a href="/company/job/job.html?act=edit&jid={$job[_jid]}&copy=1" class="copyBtn"><i></i> 克隆</a></li>
			<!--{/loop}-->
		</ul>
		<div class="checkAll">
...
<div class="mRecruit" style="display:none;">
	<a href="javascript:;" id="update_job" class="subRct01">重新发布</a>
