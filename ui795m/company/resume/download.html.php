...
<head>
	...
	<title>下载的简历-{$domainInfo['region_name_short']}597人才网触屏版</title>
...
<div class="loginPop">
	<div class="loginTopBg loginTopBg2">
		<a href="/company/resume/"><i class="icon-uniE6005"></i></a>下载的简历
	</div>
</div>
...
function load(){
	...
	$.post( "/company/resume/download.html?format=json",
	{'p':curp},
		function(data){
			if (data != null) {
