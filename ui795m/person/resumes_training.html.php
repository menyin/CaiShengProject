...
<body>
	...
	<!--{template header}-->
	<header class="pubtop">
		<a href="/person/resumes.html" class="back jpFntWes">&#xf053;</a><a href="/person/resumes.html?act=training_edit" id="btnAdd1" class="detBtn">添加</a>
		<div class="cent"><p><b>培训经历</h1></b></div>
	</header>
	<!--{/if}-->
	<section class="layout">
		<div class="part modLst workEx">
			<ul>
				...
				<li>
					<a href="resumes.html?act=training_edit&rid={$rid}&trainingid={$training[trainingid]}">
						<i class="jpFntWes">&#xf105;</i>
						<p class="tit">{$training[trainingName]}</p>
						<p>{$training[trainingSpecialty]}</p>
		...
		<div class="btns"><a href='/person/resumes.html?act=training_edit' id="btnAdd2" class="btn3 btnsF16"><i class="jpFntWes gray">&#xf055;</i>添加培训经历</a></div>
	</section>
	<!--{if $app['isNewApp']!="yes"}-->
	<!--{template footer}-->
	<!--{/if}-->
