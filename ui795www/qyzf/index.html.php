...
<script type="text/javascript" src="http://cdn.597.com/js/hzslider.js"></script>
<style>
/*焦点图*/
...
.prevCur{background:url(http://cdn.597.com/images/l.png) no-repeat;_background:none; _filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(sizingMethod=crop,src='http://cdn.597.com/images/l.png')}
.nextCur{background:url(http://cdn.597.com/images/r.png) no-repeat;_background:none; _filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(sizingMethod=crop,src='http://cdn.597.com/images/r.png') }
...
<!-- 顶部导航 -->
	...
	<div class="nav">
		<div class="navCon">
			<ul class="navList">
				<li><a href="/qyzf/" style="background:#C51504;">最新</a></li>
				<li><a href="/qyzf/hot/">热门</a></li>
				<li><a href="/qyzf/qy/">企业专访</a></li>
				<li><a href="/qyzf/gr/">个人专访</a></li>
				<li><a href="/qyzf/zf/">597专题</a></li>
			</ul>
		</div>
		<div class="clear"></div>
	</div>
<div style="width:1000px; margin:15px auto;">
	...
	<div class="main">
		<div class="slider">
			<div class="scrollBox" id="scrollBox">
				<div class="scrollPic" id="scrollPic">
					<!--{loop $zfadv $l}-->
						<div class="item current">
							<a target="_blank" href="{$l['link_url']}"><img src="http://pic.597.com/news/{$l['pic_url']}"></a>
						</div>
					<!--{/loop}-->
				</div>
				<div class="scrollDot" id="scrollDot">
					<span class=""></span>
					<span class="on"></span>
					<span class=""></span>
					<span class=""></span>
				...
				<div class="prevCur" id="prevCur"></div>
				<div class="nextCur" id="nextCur"></div>
			</div>
		</div>
	</div>
	<script type="text/javascript" language="javascript">
		...
		scrollBox0.Context=[
		{"img":"http://cdn.597.com/images/d.gif","href":""},
		...
		scrollBox0.cWidth=900;
		scrollBox0.cHeight=400;
		scrollBox0.itemWidth=800; //当前图片宽度
		scrollBox0.itemHeight=400; //当前图片高度
		scrollBox0.speedTime = 3000;
	...
	<div id="more" style="border-top:dashed 1px #999; padding-top:10px;">
		<!--加载更多内容-->
		<!--{loop $news $l}-->
	...
	<div id="drag" class="get_more" style="display: block;" >
		<div class="draginner">-- 加载更多 --</div><div id="totalpage" class="none">{$_allPages}</div>
	</div>
</div>
...
function load(){
	...
	draginner.innerHTML="-- 加载更多 --";
	$.post( "/qyzf/index.html?format=json",
	{'p':curp},
		function(data){
			if (data != null) {
