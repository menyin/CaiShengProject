...
<title><!--{if $id}-->{$category[$id]}_<!--{/if}-->HR资讯_{$domainInfo['region_name_short']}597人才网</title>
<!–[if lt IE9]>
...
<div class="content">
	<div class="bread"><a href="/" id="hrnewsCity">{$domainInfo['region_name_short']}597人才网</a>&gt;<!--{if $id}--><a href="/hrnews/">HR资讯</a>&gt;<span>{$category[$id]}</span><!--{else}--><span>HR资讯</span><!--{/if}--></div>
	<div class="wkplc">
		<div class="left">
			<div class="wkplLst leftPart">
				<div class="hd">
					<h3><!--{if $id}-->{$category[$id]}<!--{else}-->HR资讯<!--{/if}--></h3><div class="rBtn"><!--{if $id}--><a href="/hrnews/">&lt;返回</a><!--{/if}--></div>
				</div>
				<div class="bd" id="lst">
					<ul>
						<!--{loop $news $l}-->
						<li class=" noPic" title='{$l['detail_title']}'>
							<h2><a href="/hrnews/detail-{$l['detail_id']}.html" target='_blank'>{$l['detail_title']}</a></h2>
							<dl>
							<dt><a><img src="" /></a></dt>
							<dd>
								<div class="txt">
								...
								<div class="bot">
									...
									<p class="rTo"><a href="/hrnews/detail-{$l['detail_id']}.html" target='_blank'>查看详情&gt;&gt;</a></p>
								</div>
							</dd>
							</dl>
					   </li>
		...
		<div class="right">
			<div class="rightPart">
				...
				<div class="classify">
					...
					<div class="bd">
						<ul>
							<li><a href="/hrnews/list-28.html">人力管理</a></li>
							<li><a href="/hrnews/list-29.html">招聘面试</a></li>
							<li><a href="/hrnews/list-14.html">管理激励</a></li>
							<li><a href="/hrnews/list-15.html">业绩考核</a></li>
							<li><a href="/hrnews/list-17.html">法律常识</a></li>
						</ul>
						<div class="clear"></div>
					</div>
				</div>
	...
	function createTips(){
	 ...
	 $('#lst .sina').click(function()
	 {
		 var tip =  createTips(),
		 	...
		 	info = '【这篇文章还不错】' + '“'+ acttitle + '”'+ '（来自597.com  HR资讯<!--{if $id}--> -> {$category[$id]}<!--{/if}-->)，'
