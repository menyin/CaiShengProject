...
<head>
	...
	<title>招聘中心 我的597-597人才网(597.com)</title>   
...
<!--{template company/header}-->
	...
	<div class="container">
		<div class="containerCon">
			<!--{template company/message_left}-->
			<div class="right">
				<div class="crumbs"><b>您的位置：</b><a href="/">首页</a>&gt;<a href="/company/index.html">招聘中心</a>&gt;<span>我的597</span>&gt;<span>我的消息</span>&gt;<a href="/company/message.html">消息列表</a></div>
				<div class="part">
					<div class="tag">
						<!--基本内容开始-->
						<div class="tagC">
							<div class="tagCon">
								<div class="cImage">
									...
									<div class="cImageC">
										...
										<div class="teamLst" >
											<form id="formCompanyInfoMofidy" action="/company/message.html" method="post" autocomplete="off">
