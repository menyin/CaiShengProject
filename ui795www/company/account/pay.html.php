...
<body id="body">
	...
	<div id="pay-main">
		<div class="pay-container">
			...
			<form action="/company/account/pay.html" name="pay" method="post" id="pay" target="_blank">
	...
	<!--{else}-->
		<div id="pay-main">
			<div class="pay-container" style="height:200px; padding-top:100px;">尊敬的企业用户，您的营业执照未通过审核，暂时不能充值，<a href="/company/account/licence.html">查看营业执照状态</a></div>
		</div>
	<!--{/if}-->
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$('#paySubmit').click(function(){
				...
				switch(payType){
					case '10':
						$.showModal('/company/account/pay.html?act=pay&type=wx&txtAmount='+txtAmount+'&payType='+payType+'&pid={$pid}', {title:"微信支付",showMask: true });
					break;
					case '5':
