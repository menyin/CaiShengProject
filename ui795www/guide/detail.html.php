...
<div class="content">
	<div class="bread"><a href="/" id="guideCity">{$domainInfo['region_name_short']}597人才网</a>&gt;<a href="/guide/">职场指南</a>&gt;<a href="/guide/list-{$news['detail_cid']}.html">{$news['category']}</a>&gt;<span id="title">{$news['detail_title']}</span></div>
	<div class="campus">
		<div class="left">
