...
<head >
	...
	<link rel="stylesheet" type="text/css" href="http://cdn.{ROOT_DOMAIN}/css/597index.css?v=2016022269" />
	...
	<script language="javascript" type="text/javascript" src="http://cdn.{ROOT_DOMAIN}/js/index.js?v=2017"></script>
...
<body>
	...
	<div class="top">
		<div class="topCon">
			<ul id="topLoginStatus" >
				...
				<li class="top-wx" >
					微信
					<img src="http://cdn.{ROOT_DOMAIN}/img/common/wxCode.png" class="wxImg" />
					<span class="line">|</span>
				</li>
				<li class="top-phone">
					<a href="{$mobileUrl}" target="_blank" style="color:#444;font-weight:normal;" >手机版</a>
					<span class="line">|</span>
				</li>
				<li class="top-phone">
			...
			<div class="tabContents">
				<div class="tabCon">
					<ul class="tabUl tabUl01">
						<!--{loop $ad10List $l}-->
						<li><a href="/com-{$l['_cid']}/" class="aGray" target="_blank" title="{$l['cname']}">{$l['cname']}</a>
						<!--{if $l['showStatus']==0&&$l['jobList']}--><dl class="jobItems"><!--{loop $l['jobList'] $ll}--><dd><a href="/job-{$ll['_jid']}.html" target="_blank">{$ll['orderSort']}、{$ll['jname']}</a></dd><!--{/loop}--><dd class="jobMore"><a href="/com-{$l['_cid']}/" target="_blank">更多职位</a></dd></dl><!--{/if}-->
						</li>
						<!--{/loop}-->
					</ul>
				</div>
	...
	<div class="newjobArea" >
		...
		<div class="jobM">
			...
			<ul>
				...
				<!--{else}-->
					...
					<li><a href='http://www.pt597.com' target="_blank">莆田</a></li>
					<li><a href='http://www.nd597.com' target="_blank">宁德</a></li>
					<li><a href='http://www.sm597.com' target="_blank">三明</a></li>
					<li><a href='http://www.597rcw.com' target="_blank">龙岩</a></li>
		...
		<div class="jobR">
			...
			<p><a href="/person/register.html" target="_blank"><img src="http://cdn.{ROOT_DOMAIN}/img/common/reg_pic.jpg"/></a></p>
		</div>
	</div>
...
<div id="appInfo">
	<a href="/download/app/" class="app_download" id="ewm_tips" target="_blank" style=" ">
		...
		<div class="ewm_imgs">
			...
			<dl>
				<dt>微信小程序</dt>
				<dd><img src="http://cdn.597.com/img/common/xcxCode.jpg"  /></dd>
			</dl>
		</div>
	</a>
