...
$(document).ready(function(){ 
	...
	//首页
	if (pageName.indexOf('index.html')>=0 || pageName=='/') {	
		$("#menu_m1").addClass("m1_hover");
	}
	//企业信息
	if (pageName.indexOf('company.html')>=0) {
		$("#menu_m2").addClass("m2_hover");
		if (pageAtc.indexOf('cominfo')>=0) $("#menu_cominfo").addClass("act_dd");
		if (pageAtc.indexOf('comunit')>=0) $("#menu_comunit").addClass("act_dd");
		if (pageAtc.indexOf('comlice')>=0) $("#menu_comlice").addClass("act_dd");
		if (pageAtc.indexOf('comview')>=0) $("#menu_comview").addClass("act_dd");
	}
	//职位信息
	if (pageName.indexOf('job.html')>=0) {
		$("#menu_m2").addClass("m2_hover");
		if (pageAtc.indexOf('joblist')>=0) $("#menu_joblist").addClass("act_dd");
		if (pageAtc.indexOf('jobedit')>=0) $("#menu_jobedit").addClass("act_dd");
		if (pageAtc.indexOf('job2com')>=0) $("#menu_job2com").addClass("act_dd");
		if (pageAtc.indexOf('job2per')>=0) $("#menu_job2per").addClass("act_dd");
	}
}); 
...
function checkCookie2(){
	...
	if(p_info != null && p_info != false ){
			cookieValue = p_info.split("|");
			if(cookieValue != null && cookieValue.length >=9){
				cookieName = cookieValue[8];
