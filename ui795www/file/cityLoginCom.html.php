	...
	<div class="cngIdForm">
		...
		<div class="personInfo">
			...
			<div class="formMod">
				...
				<div class="r">
					<span class="formText">
						<input type="password" id="txtPwd" name="txtPwd" style="width:158px;" class="text" />
					</span>
					<span class="tipPos">
						<span class="tipLay">
						</span>
	...
	var modUser={
		...
		successCallback:function(json){
			if(json.status==1){
				...
				$.message('更改用户名成功，请用新的用户名('+json.newname+')到网站登录',{ icon: 'success',onclose:function(){window.location.href = '/company/login.html';} });
