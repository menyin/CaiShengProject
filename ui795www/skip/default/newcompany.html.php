...
<style type="text/css">
	...
	.imgEwm {position: absolute; width: 120px; right:7px; top:70px; text-align: center; color:#999;}
	.imgEwm img { width: 120px; height: 120px; display: block; margin-bottom: 5px;}
	.imgEwm p {position: relative; top:-12px;}
...
<div style="box-shadow:0 0 6px #dbdbdb;width:1000px;height:auto; margin: 20px auto; text-align:left;">
	...
	<div class="nJobMainBg">
		<div class="nJobMainCont">
			<div class="newTytit" style="padding:0;">
				<h2 style="margin-bottom:5px;">公司简介</h2>
				<div class="njmTit" id="info">{$com['comInfo']}</div>
			</div>
			<!--{if $com['showPhone']==1}-->
				<div class="newTytit" id="linkList">
					<span class="linkType">联系电话</span> {$com[comPhone]} <em>联系人：{$com[comUser]}</em>
				</div>
			<!--{/if}-->
			<div class="newTytit"  id="comAddress">
			...
			<div class="nJobmcLf" style="margin-top:30px;">
				...
				<div class="newTytit" style="float:left;padding-top:0;">
					...
					<div class="njmJoinUs">
						...
						<!--{loop $jobListAll $l}-->
							<li>
								<a href="/job-{$l['_jid']}.html" target='_blank'>
									<p>
										<span>{$l['jname']}</span> <!--{if $l['urgency']==1}--><b></b><!--{/if}--> <i>{$l['freshTime']}</i>
									</p>
									<span class="nUcolor">{$l['cuName']}  {$l['jobSalary']}  &nbsp;  {$l['jobDegree']} / {$l['jobWorkYear']} / {$l['jobArea']}</span>
								</a>
							</li>
						<!--{/loop}-->
						</ul>
		...
		<div class="newTytit" style="padding:30px;clear:both;" id="comMap">
							...
							<div id="baidu_map" class="map active"  >
								<div id="dtjt_info"><!--0326s-->
									...
									<!--03263-->
						   			...
						   			<div id="dtjt_tab1" class="tabright" style="width: 262px;">交通路线&生活信息</div>
						   			<div id="map_tab_jtlx" class="map_tab map_tab_sel" style="border-top: 1px solid #E6E6E6"></div>
					   			</div>
...
<script type="text/javascript" src="http://cdn.{ROOT_DOMAIN}/js/baiduMap.js"></script>
