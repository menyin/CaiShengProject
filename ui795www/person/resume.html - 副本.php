...
<!--{template person/newheader}-->
<!--/头部 end-->
    <div class="w1000"> 
        <!--流程-->
        <div class="step-box clearfix">
                        <div class="jl-name" id="jlName">
                <span id="resumeTimeBar" class="time">最后修改时间：2015-01-15 17:32:31</span>
                <form id="formResumeName" action='/api/web/person.api?act=resume_save' method="post">
                    <a href="/resume/manage/">我的简历</a><u>&gt;</u><span class="jname" v="{$resumeInfo[rTitle]}">{$resumeInfo[rTitle]}</span>
                ...
                <div class="r-box">
                    ...
                    <style type="text/css">
                        .precent{
                            ...
                            background:url(http://assets.huibo.com/img/v2/resume/percent.png) no-repeat;
                        }
                        .precent10{
                    ...
                    <span id="precentRound" class="precent precent30"></span>
                    
                </div>
                <ul class="r-box res-item">
                    <li class="suc"><a href="javascript:"><span>基本资料</span><em class="stas">添加</em></a></li>
                    <li class="suc"><a href="javascript:"><span>求职意向</span><em class="stas">添加</em></a></li>
                    <li><a href="javascript:"><span>自我评价</span><em class="stas">添加</em></a></li>
                    <li><a href="javascript:"><span>工作经历</span><em class="stas">添加</em></a></li>
                    <li><a href="javascript:"><span>教育背景</span><em class="stas">添加</em></a></li>
                    <li><a href="javascript:"><span>项目经验</span><em class="stas">添加</em></a></li>
                    <li><a href="javascript:"><span>语言能力</span><em class="stas">添加</em></a></li>
                    <li><a href="javascript:"><span>技能专长</span><em class="stas">添加</em></a></li>
                    <li><a href="javascript:"><span>证书</span><em class="stas">添加</em></a></li>
                    <li><a href="javascript:"><span>其他信息</span><em class="stas">添加</em></a></li>
                    <li><a href="javascript:"><span>我的作品</span><em class="stas">添加</em></a></li>
                    <li><a href="javascript:"><span>实践经验</span><em class="stas">添加</em></a></li>

                </ul>
                <p class="r-box"><a id="prestr-btn" href="javascript:" class="prestr-btn" title="保存并完成"></a></p>
                <p class="r-box"><a href='/resume/preview/resume_id-13199459' class="preview-btn" title="预览简历" target="_blank"></a></p>
            </div>
            <!--/-->
            ...
            <div id="resume-left" class="resume-left">
                ...
                <div id="baseinfor">
                    <dl class="res-infor clearfix" data-chkPhotoOpen="{$resumeInfo[isShowPhoto]}" data-chkNameOpen="{$resumeInfo[isShowFullName]}" data-idcard="{$resumeInfo[cardno]}">
                        <dt class="img"><a href="/photomodify/" target="_blank" title="修改头像"><span>修改头像</span><img src="http://cdn.597.com/img/v2/resumeM/head-defects.jpg" /></a></dt>
                        <dd class="infor-box">
                            <p class="name">
                            ...
                            <p class="inf1">
                                ...
                                <!-- <span><i class="x"></i>本科</span>  -->
                                <span id="spnWorkYear" v="{$resumeInfo['workYear']}"><i class="j"></i><b><!--{if $resumeInfo[workstate]==2}-->目前在读,{$resumeInfo['graduateDate']}毕业<!--{else}-->{$resumeInfo['toWorkYear']}年工作经验<!--{/if}--></b></span>
                                <span id="spnBasicCurArea" v="{$resumeInfo[residenceid]}"><i class="d"></i>{$resumeInfo['residenceName']}</span>
                            </p>
                            <p class="inf2">
                                ...
                                <span id="spnBasicStature" v="{$resumeInfo[stature]}/{$resumeInfo[avoirdupois]}">{$resumeInfo['statureInfo']}</span><u>-</u>
                                <span id="spnBasicPolitical" v="{$resumeInfo[political]}">{$resumeInfo['politicalInfo']}</span>
                            </p>
                            <p class="link">
                                <span id="spnBasicMobilePhone" data-bind="1" ><i class="p"></i><strong>{$resumeInfo['mobile']}</strong><em id="phoneAddr"></em></span>
                                <span id="spnBasicEmail" data-bind="" ><strong>邮箱：{$resumeInfo['email']}</strong></span>
                                <span id="spnBasicQQ" class="last" v="{$resumeInfo[qq]}" style="display:none"><strong>QQ：{$resumeInfo['qq']}</strong></span>
                            </p>
                        </dd>
                    </dl>
                    <!--/-->
                    ...
                    <div class="edit-status-box" style="display:none;position: relative;zoom:1">
                        ...
                        <div class="create-item step1">
                            <div class="clearfix">
                                <div class="head-img">
                                    <a href="/photomodify/" target="_blank" title="修改头像"><span>上传头像</span></a>
                        ...
                        <!--联系方式-->
                        <p class="create-tit"><strong class="name">联系方式</strong> (手机号码、其它号码需填一项)</p>
                    ...
                    <div class="edit-status-box create-item step21" style="display:none">
                        ...
                        <dl class="clearfix">
                            ...
                            <dd class="formRows">
                                ...
                                <label id="radHideSalary" class="icon-chck mgl10 mgt5 left" data-name="radHideSalary" data-value="1"><em></em>面议</label>
                ...
                <!--自我评价-->
                <div id="appraise">
                    <p class="resume-tit" data-content="{$resumeInfo[joinEvaluate]}"><strong class="name">自我评价</strong><a href="javascript:" class="edit"><i></i><span>添加</span></a><span class="no-data" >填写自我评价</span></p>
                    <div class="resume-item">                
                        <!--有数据 开始-->
                        ...
                        <dl class="clearfix">
                            ...
                            <dd class="formRows">
                                ...
                                <div id="rsExample01" class="rsExample">
                                    <img src="http://assets.huibo.com/img/v2/resume/steel02.png" />
                                ...
                                <div id="rsExample02" class="rsExample">
                                    <img style="margin-left:107px;" src="http://assets.huibo.com/img/v2/resume/steel02.png" />
                                    <div class="reExamList">
               ...
               <!--编辑状态结束-->
                ...
                <div id="workInfor">
                    ...
                    <div class="resume-item">                                               
                        ...
                        <!--{if $resumeInfo['workListInfo']}-->
                            ...
                            <div class="exper" >
                                <div class="workRows clearfix editPanel" data-workid="{$l[workid]}" data-workJobType="{$l[WorkJobType]}" data-jobsortContainer="{$l[workJobClassId]}" data-founder="0" data-salarySecrecy="{$l[workHideSalary]}">
                                    <span class="time" data-startTime="{$l[_workDateStart]}" data-endTime="{$l[_workDateEnd]}">{$l[workStartDate]}<!--{if $l[workEndDate]}-->-{$l[workEndDate]}<!--{else}--> 至今<!--{/if}--><br />[{$l[workyear]}年]</span>
                                    <div class="box-item">
                                        <p class="tit">
                                            <span class="oper"><a href="javascript:" title="编辑" class="edt">编辑</a><a href="javascript:" class="del" title="删除">删除</a></span>
                                            <strong class="name jobName" v="{$l[workOffice]}"><!--{if $l[WorkJobType]==2}--><span class="tag">兼职</span><!--{/if}--><!--{if $l[WorkJobType]==3}--><span class="tag">实习</span><!--{/if}-->{$l[workOffice]}</strong><u>|</u><strong class="name companyName">{$l[workName]}</strong>
                                        </p>
                                        <div class="infor">
                                            <p class="mgb10"><span class="salary" v="{$l[workSalary]}"><!--{if $l[workSalary]&&!$l[workHideSalary]}-->{$l[workSalary]}元/月<!--{/if}--><!--{if $l[workHideSalary]}-->薪资保密<!--{/if}--></span> <!--{if $l[WorkJobType]}-->- <span class="joblevel" v="{$l[WorkJobLevel]}">{$l['WorkJobLevelInfo']}</span><!--{/if}--> <!--{if $l[WorkComProperty]}-->- <span class="comProperty" v="{$l[WorkComProperty]}">{$l['WorkComPropertyInfo']}</span>，<!--{/if}--><span class="callingContainer" v="{$l[workIndustryId]}">{$l['joinIndustryName']}</span>，<span class="comSize" v="{$l[WorkComSize]}">{$l['WorkComSizeInfo']}</span></p>
                                            ...
                                            <ul class="fanwei">
                                                 <li style="display:none">
                                                    <strong>管辖范围：</strong>
                                                    <span class="dempartment" v="{$l[WorkManageDempartment]}"><!--{if $l[WorkManageDempartment]}-->{$l[WorkManageDempartment]}<!--{else}-->未填写<!--{/if}--></span>
                                                </li>
                                                <li style="display:none">
                                                    <strong>下属人数：</strong>
                                                    <span class="workSubordinate" v="{$l[WorkSubordinate]}"><!--{if $l[WorkSubordinate]}-->{$l[WorkSubordinate]}人<!--{else}-->未填写<!--{/if}--></span>
                                                ...
                                                <li style="display:none">
                                                    <strong>离职原因：</strong>
                                                    <span class="dimContent" v="{$l[WorkLeaveReason]}"><!--{if $l[WorkLeaveReason]}-->{$l[WorkLeaveReason]}<!--{else}-->未填写<!--{/if}--></span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                    ...
                    <div class="edit-status-box create-item" style="display: none;zoom:1">
                        ...
                        <dl class="clearfix">
                            ...
                            <dd class="formRows">
                                <div id="selWorkComProperty" class="dropv2 mgr10" style="width:125px;">
                                    <b class="jpFntWes dropIco">&#xf0d7;</b>
                                    <label>请选择</label>
                                    <ul></ul>
                                </div>
                        ...
                        <dl class="clearfix">
                            ...
                            <dd class="formRows select-group-row" style="z-index:3">                            
                                <div id="selWorkJobType" class="dropv2 mgr10" style="width:125px;">
                                    <b class="jpFntWes dropIco">&#xf0d7;</b>
                                    <label>全职</label>
                                    <ul></ul>
                                </div>
                                <div class="formMod JobCayMod checkMod" style="float:left;margin-bottom: 0px">
                        ...
                        <!--{loop $resumeInfo[projectListInfo] $l}-->
                                <div class="clearfix projectRows editPanel" data-projectid="{$l[projectid]}">
                                    ...
                                    <div class="box-item">
                                        ...
                                        <div class="infor">
                                            <p class="pfc labelProjectIntr" data-projectIntr="{$l[projectIntr]}" ><i class="jpFntWes">&#xf10d;</i><span>{$l[projectIntr]}</span><i class="jpFntWes">&#xf10e;</i></p>
                ...
                <div id="languageInfor">
                    <p class="resume-tit"><strong class="name">语言能力</strong><a href="javascript:" class="edit"><i></i><span>编辑</span></a><span class="no-data" >更多的语言能力可以让你在职场中更有竞争力</span></p>
                    <div class="resume-item">
                        <!--有数据 开始-->
                ...
                <!--技能专长-->
                <div id="skillInfor">
                    <p class="resume-tit"><strong class="name">技能专长</strong><a href="javascript:" class="edit"><i></i><span>编辑</span></a><span class="no-data" >概括您所掌握的技能、专长和擅长的领域</span></p>
                    <div class="resume-item">                   
                        <!--有数据 开始-->
                        <ul class="clearfix tag-box">
                ...
                <!--证书-->
                <div id="cardInfor">
                    <p class="resume-tit"><strong class="name">证书</strong><a href="javascript:" class="edit"><i></i><span>编辑</span></a><span class="no-data" >HR可能会通过专业技能或职业职称证书来搜寻人才</span></p>
                    <div class="resume-item">                   
                        <!--有数据 开始-->
                        <ul class="clearfix tag-box">
                        ...
                        <!--{if $resumeInfo[otherinfoListInfo]}-->
                            <!--{loop $resumeInfo[otherinfoListInfo] $l}-->
                                <div class="clearfix otherRows editPanel" data-appendid="{$l[otherinfoid]}">
                                    ...
                                    <p class="infor"><span class="oper"><a href="javascript:" title="编辑" class="edt">编辑</a><a href="javascript:" class="del" title="删除">删除</a></span><i class="yuan"></i><span class="topicContent">{$l[TopicContent]}</span></p>
                                </div>
                            <!--{/loop}-->
                        <!--{/if}-->
        ...
        <!--主体结束-->
        <div class="footer">©2015 597人才网 版权所有</div> 
    </div>
    <script type="text/javascript">
    var scroll_flag = '';
    var styleUrl = "http://assets.huibo.com";
    var upload_cookie_userid='11595237';
    var upload_cookie_nickname='小越';
    var upload_cookie_usertype='p';
    var upload_cookie_userkey='bfe9699e3bae36eef51e108911e88acb';
    var is_create = '';
    var complete_url = '/person/ResumeComplete/resume_id-13199459';
    var manage_url = '/resume/manage/';
    ...
    var complete_percent = 30;
    var resume_id = '13199459';
    ...
    var comPropertyItems = [{value:'',label:'请选择'}];
            comPropertyItems.push({value:'1',label:'私营/民营'});
            comPropertyItems.push({value:'2',label:'国有企业'});
            comPropertyItems.push({value:'3',label:'合资'});
            comPropertyItems.push({value:'4',label:'外资'});
            comPropertyItems.push({value:'5',label:'政府机关'});
            comPropertyItems.push({value:'6',label:'事业单位'});
            comPropertyItems.push({value:'7',label:'非盈利机构'});
            comPropertyItems.push({value:'99',label:'其他'});
        var jobTypeItems = [];
    ...
    jpjs.loadJS('http://cdn1.597.com/min/js/v2/nonModular/v2-resume.js?v=2015011601');
...
#fancybox-loading, .fancybox-close, .fancybox-prev span, .fancybox-next span {background-image: url(http://assets.huibo.com/img/comshow/fancybox_sprite.png);}
#fancybox-loading {position: fixed;top: 50%;left: 50%;margin-top: -22px;margin-left: -22px;background-position: 0 -108px;opacity: 0.8;cursor: pointer;z-index: 8060;}
#fancybox-loading div {width: 44px;height: 44px;background: url(http://assets.huibo.com/img/comshow/fancybox_loading.gif) center center no-repeat;}
.fancybox-close {position: absolute;top: -18px;right: -18px;width: 36px;height: 36px;cursor: pointer;z-index: 8040;}
.fancybox-nav {position: absolute;top: 0;width: 40%;height: 100%;cursor: pointer;text-decoration: none;background: transparent url(http://assets.huibo.com/img/comshow/blank.gif); /* helps IE */-webkit-tap-highlight-color: rgba(0,0,0,0);z-index: 8040;}
...
.fancybox-overlay {position: absolute;top: 0;left: 0;overflow: hidden;display: none;z-index: 8010;background: url(http://assets.huibo.com/img/comshow/fancybox_overlay.png);}
...
@media only screen and (-webkit-min-device-pixel-ratio: 1.5),
    ...
    #fancybox-loading, .fancybox-close, .fancybox-prev span, .fancybox-next span {
        background-image: url(http://assets.huibo.com/img/comshow/fancybox_sprite@2x.png);
        background-size: 44px 152px; /*The size of the normal image, half the size of the hi-res image*/
    }

    #fancybox-loading div {
        background-image: url(http://assets.huibo.com/img/comshow/fancybox_loading@2x.gif);
