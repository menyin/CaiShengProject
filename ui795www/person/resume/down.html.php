...
<head>
	...
	<title>597人才网_求职中心_谁下载了我的简历</title>
...
<body id="body" class="noResize minMain">
	...
	<div class="w1000 clearfix">
		...
		<div class="right-main">
			...
			<p>&nbsp;</p>
			<p>&nbsp;</p>
			<!--<p align="right" ><a href="javascript:void(0);" class="btn2 btnsF14 updateAll">若数据有重复或丢失，请点击此处更新数据！</a></p>-->
			<p>&nbsp;</p>
			<table class="browse-list">
				...
				<tr>
					<td>{$l[_createTime]}</td>
					<td><a target="_blank" href="http://www.{ROOT_DOMAIN}/com-{$l[_cid]}/">{$l[cname]}</a></td>
	...
	<script>
		...
		jpjs.use('widge.overlay.jpDialog',function(Dialog,$) {
			var qxtd = new Dialog({
					idName: 'qxtd-alert',
					title: '提示',
					close: 'x',
			...
			$(".updateAll").click(function(){
				var url = 'http://www.597.com/tool/xm/check_per_www.php?&type=1';
				qxtd.setContent({
					content : url,
					title : '数据更新需要几分钟，请耐心等待'
				});
				qxtd.show();
			});
		});
