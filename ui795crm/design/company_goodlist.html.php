							...
							<table class="has_checkbox">
								...
								<tbody data-bind="foreach: items">
									<tr class="">
										...
										<td><!--{if $result[isWords]==0}--><a href="http://pic.{ROOT_DOMAIN}/adv/{$result[logo]}" target="_blank"><img src="http://pic.{ROOT_DOMAIN}/pos/{$result[logo]}" width="150" height="50"></a><!--{/if}--></td>
										<td>
