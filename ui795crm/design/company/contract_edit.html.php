													...
													<div class="cell_tb_list">
														<table>
															...
															<tr>
																...
																<td><div class="formMod"><span class="formText"><input type="text" class="text" id="txtEndDate" name="txtEndDate" placeholder="" value="{$contract[endDate]}" onclick="WdatePicker({minDate: '{$date}' ,alwaysUseStartDate: true })" required="required"/></span>
																	<span class="tipPos">
																		<span class="tipLay "></span>
																	</span>
																	<div class="clear"></div></div></td>
