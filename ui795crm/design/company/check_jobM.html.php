                      ...
                      <td><table width="100%" border="0" cellspacing="1" cellpadding="4">
                          <tbody>
                            ...
                            <tr bgcolor="#FFFFFF">
                              ...
                              <td height="23" colspan="3"><strong>{$job[$key]['comEmail']}</strong></td>
                            </tr>
                            <tr bgcolor="#FFFFFF">
                              <td height="1" colspan="4" bgcolor="#dddddd"></td>
                            </tr>
                  ...
                  <tbody>
                    <tr>
                      <td>
                        ...
                        <textarea id="job{$job[$key][_jid]}" cols="100" rows="16" readonly="readonly">{$job[$key]['jobContent']}</textarea>
                        <br><br>
                      ...
                      <tbody>
                        <tr bgcolor="#FFFFFF">
                          <td colspan="2"><a onClick="form{$job[$key]['jid']}.Remark.value=form{$job[$key]['jid']}.Remark.value+'多个岗位不可发布在同一个职位中，多个岗位请重新分开发布。';" style="cursor:hand"><u>1.多个岗位不可发布在同一个职位中，多个岗位请重新分开发布。</u></a><br>
                            ...
                            <a onClick="form{$job[$key]['jid']}.Remark.value=form{$job[$key]['jid']}.Remark.value+'此岗位已有发布，不得发布重复岗位，请删除。';" style="cursor:hand"><u>5.此岗位已有发布，不得发布重复岗位，请删除。</u></a></td>
                        </tr>
                        <tr bgcolor="#FFFFFF">
