								...
								<tbody>
									<tr class="">
										...
										<td>
											...
											<a class="btn_s" href="company.html?act=check_ok&c_id={$company[_cid]}" onclick="return confirm('确认要通过吗？');">通过</a>
											<a class="btn_s" href="company.html?act=check_no&c_id={$company[_cid]}" onclick="return confirm('确认要屏蔽吗？');">屏蔽</a>
											<!--{else}-->
