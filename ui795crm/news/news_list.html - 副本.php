						...
						<div class="cell_tb_list">
							<table class="has_checkbox">
								...
								<tbody data-bind="foreach: items">
									<tr class="">
										<td>{$news1[detail_id]}</td>
										<td>{$news1[detail_title]}</td>
										...
										<td>
											...
											<a class="btn_s" href="news.html?act=delete&detail_id={$news1[detail_id]}&detail_cid={$news1[detail_cid]}" onclick="return confirm('确认需要删除些信息吗？');" >删除</a>
										</td>
									</tr>
								</tbody>
								<!--{/loop}-->
