	...
	<div id="contentBody" style="visibility: visible;">
		...
		<div class="content" style="">
			<div id="main" class="security-groups" style="">
				<div class="title">
					<div class="m_bg">销售管理 >  <a href="contract.html?act=comlist&op=all&c_id={$_cid}">公司：[{$com[cname]}] 合同总列表</a> ><a href="contract.html?act=comlist&op=all&c_id={$_cid}"> 合同：[{$contract[title]}] </a> > 合同升级</div>
				</div>
				<div class="quickbar">
