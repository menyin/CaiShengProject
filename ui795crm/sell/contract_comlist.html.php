	...
	<div id="contentBody" style="visibility: visible;">
		...
		<div class="content" style="">
			<div id="main" class="security-groups" style="">
				<div class="title">
					<div class="m_bg">销售管理 > <a href="company.html?act=mylist&ordertype=3&query=">我的企业</a> >  公司：[{$com[cname]}] 合同管理</div>
				</div>
				<div class="quickbar">
									...
									<tr class="">
										...
										<td>
											...
											<!--{if !$contract[advStatus]}-->
												<a class="btn_s" href="contract.html?act=advInfoedit&contractId={$contract[contractId]}&c_id={$_cid}"  style="display:none;">新建广告</a>
											<!--{else}-->
												<a class="btn_s" href="contract.html?act=advlist&contractId={$contract[contractId]}&c_id={$_cid}" style="display:none;">广告位</a>
											<!--{/if}-->
											<!--{if ($contract[contract_status]==2)}-->
												<a class="btn_s" href="contract.html?act=xfedit&parentId={$contract[contractId]}&c_id={$_cid}" >续费</a>
												<a class="btn_s" href="contract.html?act=sjedit&parentId={$contract[contractId]}&c_id={$_cid}" >升级</a>
											<!--{/if}-->
											<!--{if ($contract[contract_status]<1)}-->
												<a class="btn_s" href="contract.html?act=del&contractId={$contract[contractId]}&c_id={$_cid}" onclick="return confirm('确认需要删除这些信息吗？');">删除</a>
											<!--{/if}-->
										</td>
									</tr>
								</tbody>
