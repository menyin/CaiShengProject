													...
													<div class="cell_tb_list">
														<table>
															...
															<tr>
																...
																<td colspan=3><div class="formMod addressMod">
																	<select id="cityid" name="cityid" onchange="selectcity();" class="drop" style="width: 160px;" required="required" message="请选择所属的站点">
																		<option value="0" <!--{if $contractId}--> disabled <!--{/if}--> <!--{if $cityid==0}--> selected <!--{/if}--> >全国</option>
															...
															<tr>
																...
																<td><div class="formMod"><span class="formText"><input type="text" class="text" id="txtStartDate" name="txtStartDate" placeholder="" value="{$contract[startDate]}" onclick="WdatePicker({minDate: '{$date}' ,alwaysUseStartDate: true })" required="required" readonly="readonly"/></span>
																	<span class="tipPos">
																		<span class="tipLay "></span>
																	</span>
																	<div class="clear"></div></div></td>
