	...
	<div id="contentBody" style="visibility: visible;">
		...
		<div class="content" style="">
			<div id="main" class="security-groups" style="">
				<div class="title">
					<div class="m_bg">销售管理 > <a href="company.html?act=mylist&ordertype=3&query=">我的企业</a> > <a href="contract.html?act=comlist&op=all&c_id={$_cid}">公司：[{$com[cname]}] 合同总列表</a> > 合同：<a href="contract.html?act=comlist&op=all&c_id={$_cid}">[{$contract[title]}]</a> > 合同续费</div>
				</div>
				<div class="quickbar">
					...
					<div class="btns">
						<div class="btn-line clearfix">
							...
							<span class="gray"><a href="/sell/contract.html?act=comlist&op=all&c_id={$_cid}">返回合同列表</a></span> -->
													...
													<div class="cell_tb_list">
														<table>
															...
															<tr>
																...
																<td><div class="formMod"><span class="formText"><input type="text" class="text" id="txtEndDate" name="txtEndDate" placeholder="" value="" onclick="WdatePicker({startDate:'{$contract[startDate]}',dateFmt:'yyyy-MM-dd',minDate: '<!--{if {$contract[endDate]}<=$date}-->{$date}<!--{else}-->{$contract[endDate]}<!--{/if}-->'})" required="required" style="color:gray;"/></span>
																	<span class="tipPos">
																		<span class="tipLay "></span>
																	</span>
																	<div class="clear"></div></div></td>
