									...
									<tr class="">
										...
										<td>
											...
											<!--{if $pay1[pay_status]==0}-->
												<!--{if in_array('已支付', $__r)}-->
													<a class="btn_s" href="pay.html?act=check_ok1&pay_id={$pay1[pay_id]}" onclick="return confirm('确认需要支付吗？');">已支付</a>
												<!--{/if}-->
												<!--{if in_array('已关闭', $__r)}-->
													<a class="btn_s" href="pay.html?act=check_no&pay_id={$pay1[pay_id]}" onclick="return confirm('确认需要关闭吗？');">已关闭</a>
												<!--{/if}-->
											<!--{elseif $pay1[pay_status]==1}-->
												<!--{if in_array('已结算', $__r)}-->
													<a class="btn_s" href="pay.html?act=check_ok2&pay_id={$pay1[pay_id]}" onclick="return confirm('确认需要结算吗？');">已结算</a>
												<!--{/if}-->
											<!--{elseif $pay1[pay_status]==3}-->
												<!--{if in_array('财务初始', $__r)}-->
													<a class="btn_s" href="pay.html?act=check_ischeck&pay_id={$pay1[pay_id]}" onclick="return confirm('确认需要初始吗？');">初始</a>
												<!--{/if}-->
											<!--{/if}-->
										</td>
									</tr>
