	...
	<div id="contentBody" style="visibility: visible;">
		...
		<div class="content" style="">
			<div id="main" class="security-groups" style="">
				<div class="title">
					<div class="m_bg">销售管理 > <a href="company.html?act=mylist&ordertype=3&query=">我的企业</a>  > <a href="contract.html?act=comlist&op=all&c_id={$_cid}"> 公司：[{$com[cname]}]  合同总列表</a> > 合同：[{$contract[title]}] > 广告位总列表</div>
				</div>
				<div class="quickbar">
								...
								<tbody>
									<tr class="">
										...
										<td>
											...
											<!--{/if}-->	
											<!--{if ($contract[contract_status]<1)}-->
												<a class="btn_s" href="contract.html?act=advdel&caid={$adv[caid]}&contractId={$adv[contractId]}&c_id={$_cid}" onclick="return confirm('确认需要删除这些信息吗？');">删除</a>
											<!--{/if}-->
