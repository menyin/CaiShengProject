	...
	<div id="contentBody" style="visibility: visible;">
		...
		<div class="content" style="">
			<div id="main" class="security-groups" style="">
				<div class="title">
					<div class="m_bg">销售管理 > 操作日志 > 公司 ：<a href="http://www.{ROOT_DOMAIN}/com-{$_cid}/" target="_blank">{$com[cname]}</a></div>
				</div>
				<div class="quickbar">
										...
										<div style="float:left;">每页
											<select onchange="window.location.href=$(this).val();">
												<!--{loop $__ppStr $key $value}-->
													<option value="editlog.html?act={$act}&c_id={$_cid}&_ordertype={$_ordertype}&_query={$_query}&_page={$_page}&query_day={$query_day}{$value}" <!--{if $pp==$key}-->selected<!--{/if}-->>{$key}</option>
												<!--{/loop}-->
