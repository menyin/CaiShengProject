	...
	<div id="contentBody" style="visibility: visible;">
		...
		<div class="content" style="">
			<div id="main" class="security-groups" style="">
				<div class="title">
					<div class="m_bg">销售管理 > 我的企业 > 企业跟进</div>
				</div>
				<div class="quickbar">
							...
							<div class="mod_pool">
								<div class="summary">
									<div class="apply_main">
										<div class="apply">
											<div class="apply_1">
												<form id="postForm" name="postForm" method="post" action="/sell/company.html">
													...
													<div class="cell_tb_list">
														<table style="margin-top: 0px;">
															<tr>
																...
																<td width="85%"><span style="float:left;"><b>{$com[cname]}</b>&nbsp;&nbsp;&nbsp;<!--{if $com[comUser] || $com[comPhone] || $com[comMobile]}-->(联系人：{$com[comUser]}；联系电话：{$com[comPhone]}；联系手机：{$com[comMobile]})<!--{/if}-->&nbsp;&nbsp;&nbsp;&nbsp;</span><a class="btn_s"  href="/companyinfo/companyinfo.html?act=view&c_id={$com['_cid']}" target="_blank">查看详情</a><!--{if $com['adminId']==$_SESSION['adminid']&&!$com['vipTime']}--><a class="btn_s" href="company.html?act=remove&c_id={$com[_cid]}" onclick="return confirm('确认要放弃跟单吗？');">放弃跟单</a><!--{/if}-->
																<!--{if !$com['delStatus'] && $com['adminId']==$_SESSION['adminid']}-->
																	<a class="btn_s" onclick="Boxy.load('company.html?act=delApply&c_id={$com[_cid]}',{title: '企业提交删除申请'});">提交删除</a>
																<!--{elseif $com['delStatus']}-->
																<span>{$com['str']}</span><a class="btn_s" href="company.html?act=cancel_del&c_id={$company[_cid]}"><span style="color:red;">恢复申请并跟单</span></a>
																<!--{/if}--></td>
															</tr>
															<!--{if $com['adminId']==$_SESSION['adminid']}-->
															<tr>
																<td class="tb_title">客户类别：</td>
										...
										<iframe src="/sell/company.php?act=followView&c_id={$com[_cid]}" width="100%" height="500" frameborder=0></iframe>
									</div>
								</div>
							</div>
						</div>
