	...
	<div id="contentBody" style="visibility: visible;">
		...
		<div class="content" style="">
			<div id="main" class="security-groups" style="">
				<div class="title">
					<div class="m_bg">销售管理 > <a href="company.html?act=mylist&ordertype=3&query=">我的企业</a>  > <a href="contract.html?act=comlist&op=all&c_id={$_cid}"> 公司：[{$com[cname]}] 合同总列表</a> > 新建公司：[{$cname}] 合同</div>
				</div>
				<div class="quickbar">
														...
														<table>
															<tr <!--{if $contract[contractId]}--> style="display:none;"<!--{/if}-->>
																...
																<td colspan=3>
																	...
																	<input name="ctype" type="radio" value="21" onclick="change(21);" id="right21" /><label for="right21">普通单月会员</label>
																	<input name="ctype" type="radio" value="22" onclick="change(22);" id="right22" /><label for="right22">全年100会员</label>
																	...
																	<input name="ctype" type="radio" value="20" onclick="change(20);" id="right20" /><label for="right20">特定全年会员</label>
																	<!--<input name="ctype" type="radio" value="3" onclick="change(3);" id="right3"/><label for="right3">铂金全年会员</label>-->
																	<input name="ctype" type="radio" value="7" onclick="change(7);" id="right7"/><label for="right7">钻石三年会员</label>
																	<input name="ctype" type="radio" value="9" onclick="change(9);" id="right9"/><label for="right9">特惠两年会员</label>
																	<div style="height:10px;"></div>
															...
															<tr>
																...
																<td><div class="formMod"><span class="formText"><input type="text" class="text" id="txtEndDate" name="txtEndDate" placeholder="" value="<!--{if $contract[endDate]}-->{$contract[endDate]}<!--{else}-->{$nextTime}<!--{/if}-->" onclick="WdatePicker({startDate:'{$contract[startDate]}',dateFmt:'yyyy-MM-dd',minDate: '{$date}'})" required="required" /></span>
																	<span class="tipPos">
																		<span class="tipLay "></span>
																	</span>
																	<div class="clear"></div></div></td>
...
function change(i){
	switch(i)
	{
		case 1:
			...
			$("#txtContract_resume").val(400);
			$("#txtContract_sms").val(0);
			$("#txtContract_month").val(400);
			$("#txtContract_price").val(399);
		...
		case 21:
			$("#txtTitle").val("普通单月会员 ");
			$("#txtContract_job").val(5);
			$("#txtContract_resume").val(50);
			$("#txtContract_sms").val(0);
			$("#txtContract_month").val(50);
			$("#txtContract_price").val(120);
			$("#txtEndDate").val('{$nextTime30}');
			break;
		case 22:
