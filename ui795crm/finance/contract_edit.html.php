	...
	<div id="contentBody" style="visibility: visible;">
		...
		<div class="content" style="">
			<div id="main" class="security-groups" style="">
				<div class="title">
					<div class="m_bg">财务管理 > 公司：[{$cname}] 合同</div>
				</div>
				<div class="quickbar">
										...
										<div class="apply">
											<div class="apply_1">
												...
												<form id="postForm" name="postForm" method="post" action="contract.html">
													...
													<div class="cell_tb_list">
														<table>
															<tr <!--{if $contract[contractId]}--> style="display:none;"<!--{/if}-->>
																<td class="tb_title" width="140">合同模板：</td>
																<td colspan=7>
															...
															<tr style="display:none;">
																<td class="tb_title" width="140">合同编号：</td>
																<td colspan=7>{$contract['contractId']}</td>
															</tr>
															<tr>
																<td class="tb_title">站点区域：</td>
																<td colspan=7><div class="formMod addressMod">
															...
															<tr>
																<td class="tb_title" width="140">合同标题：</td>
																<td colspan=7><div class="formMod"><span class="formText"><input type="text" class="text" id="txtTitle" name="txtTitle" placeholder="" value="{$contract[_title]}" size="50" /><input type="hidden" name="region_name_short"  value="{$contract[region_name_short]}"/></span>
																	<span class="tipPos">
																		<span class="tipLay "></span>
																	</span>
															...
															<tr>
																...
																<td colspan="3"><div class="formMod"><span class="formText"><input type="text" class="text" id="txtStartDate" name="txtStartDate" placeholder="" value="<!--{if $contract[startDate]}-->{$contract[startDate]}<!--{else}-->{$date}<!--{/if}-->" onClick="WdatePicker({startDate:'{$contract[endDate]}',dateFmt:'yyyy-MM-dd',minDate: '{$date}'})" required="required" /></span>
																	<span class="tipPos">
																		<span class="tipLay "></span>
																	</span>
																	<div class="clear"></div></div></td>
																<td width="96" class="tb_title">结束时间：</td>
																<td colspan="3"><div class="formMod"><span class="formText"><input type="text" class="text" id="txtEndDate" name="txtEndDate" placeholder="" value="<!--{if $contract[endDate]}-->{$contract[endDate]}<!--{else}-->{$nextTime}<!--{/if}-->" onClick="WdatePicker({startDate:'{$contract[endDate]}',dateFmt:'yyyy-MM-dd',minDate: '{$date}'})" required="required" /></span>
																	<span class="tipPos">
																		<span class="tipLay "></span>
																	</span>
																	<div class="clear"></div></div></td>
															...
															<tr>
																...
																<td width="10%"><input type="text" id="txtContract_job" name="txtContract_job" placeholder="" value="{$contract[contract_job]}" required="required" onKeyUp="this.value=this.value.replace(/[^0-9-]+/,'');" style="height: 28px;line-height: 28px;border: 1px solid #cfcfcf;" size="10" /></td>
																<td width="10%">剩余职位数：</td>
																<td width="10%"><input type="text" id="_jobNum" name="_jobNum" placeholder="" value="{$product[_jobNum]}" required="required" onKeyUp="this.value=this.value.replace(/[^0-9-]+/,'');" style="height: 28px;line-height: 28px;border: 1px solid #cfcfcf;color:red;"  size="10"/></td>
																<td class="tb_title">简历数：</td>
																<td width="10%"><input type="text" id="txtContract_resume" name="txtContract_resume" placeholder="" value="{$contract[contract_resume]}" required="required" onKeyUp="this.value=this.value.replace(/[^0-9-]+/,'');" style="height: 28px;line-height: 28px;border: 1px solid #cfcfcf;" size="10"/></td>
																<td width="10%">剩余简历数：</td>
																<td width="10%"><input type="text" id="_resumeNum" name="_resumeNum" placeholder="" value="{$product[_resumeNum]}" required="required" onKeyUp="this.value=this.value.replace(/[^0-9-]+/,'');" style="height: 28px;line-height: 28px;border: 1px solid #cfcfcf;color:red;" size="10"/></td>
															</tr>
															<tr>
																<td class="tb_title">短信数：</td>
																<td colspan="3"><div class="formMod"><span class="formText"><input type="text" class="text" id="txtContract_sms" name="txtContract_sms" placeholder="" value="{$contract[contract_sms]}" required="required" onKeyUp="this.value=this.value.replace(/[^0-9-]+/,'');"/></span>
																	<span class="tipPos">
																		<span class="tipLay "></span>
																	</span>
																	<div class="clear"></div></div></td>
																<td class="tb_title">月下载数：</td>
																<td width="10%"><input type="text" class="text" id="txtContract_month" name="txtContract_month" placeholder="" value="{$contract[contract_month]}" required="required" onKeyUp="this.value=this.value.replace(/[^0-9-]+/,'');"/></td>
																<td width="10%">剩余月下载数：</td>
																<td width="10%"><input type="text" id="_monthDownload" name="_monthDownload" placeholder="" value="{$product[_monthDownload]}" required="required" onKeyUp="this.value=this.value.replace(/[^0-9-]+/,'');" style="height: 28px;line-height: 28px;border: 1px solid #cfcfcf;color:red;" size="10"/></td>
															</tr>
															<tr>
																<td class="tb_title">实际价格：</td>
																<td colspan="7"><div class="formMod"><span class="formText"><input type="text" class="text" id="txtContract_price" name="txtContract_price" placeholder="" value="{$contract[contract_price]}"  required="required"/></span>
																	<span class="tipPos">
																		<span class="tipLay "></span>
																	</span>
																	<div class="clear"></div></div></td>
															...
															<tr>
																...
																<td colspan=7><textarea type="text" class="text1" id="txtContract_remark" name="txtContract_remark" rows="2" message="合同备注" style="margin: 0px; width: 100%;">{$contract[contract_remark]}</textarea></td>
															</tr>
															<tr>
																<td class="tb_title">票据信息：</td>
																<td colspan=7><textarea type="text" class="text1" id="txtContract_other" name="txtContract_other" rows="2" message="票据信息" style="margin: 0px; width: 100%;">{$contract[contract_other]}</textarea></td>
															</tr>
														</table>
													</div>
													...
													<div class="apply_btn_next">
														<div class="apply_btn_bg">
															<a class="apply_1_next" onclick="sub(1);">无广告位会员（完成）</a>
														</div>
														<div class="apply_btn_bg">
