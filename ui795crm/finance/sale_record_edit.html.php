								...
								<div class="summary">
									<div class="apply_main">
										<div class="apply">
											<div class="apply_1">
												<div class="">
												<form id="postForm" name="postForm" method="post" action="/service/sale_record.html">
													...
													<div class="cell_tb_list">
														<table style="margin-top: 0px;">
															...
															<tr>
																...
																<td >新旧单：</td>
																<td >
																	<input type="radio"  name="NewOld" value="1" id="right1" <!--{if $result[new_old]==1}-->checked<!--{/if}-->/><label for="right1">新单</label>&nbsp;&nbsp;
																	<input type="radio"  name="NewOld" value="0" id="right11" <!--{if $result[new_old]==0}-->checked<!--{/if}-->/><label for="right11">旧单</label>
																</td>
															</tr>
															<tr>
																...
																<td >是否有执照：</td>
																<td >
																	<input type="radio"  name="license" value="1" id="right21" <!--{if $result[license]==1}-->checked<!--{/if}-->/><label for="right21">是</label>&nbsp;&nbsp;
																	<input type="radio"  name="license" value="0" id="right211" <!--{if $result[license]==0}-->checked<!--{/if}-->/><label for="right211">否</label></td>
															</tr>
															<tr>
																<td class="tb_title">金额：</td>
																<td ><div class="formMod addressMod"><span class="formText"><input type="text" class="text" id="amount_money" name="amount_money" placeholder="" value="{$result[contract_price]}" disabled="disabled"></span>
																	<span class="tipPos">
																		<span class="tipLay "></span>
																	</span>
																	<div class="clear"></div></div></td>
															...
															<tr>
																...
																<td colspan="3" ><div class="formMod addressMod"><span class="formText" >
																	<span id="contract41"><input name="receipt" type="radio" value="1" id="right103" <!--{if $result['receipt']==1}-->checked<!--{/if}--> /></span><label for="right103"><input type="text" class="text" id="transferTime" name="transferTime" placeholder="" value="<!--{if $result[transferTime]}-->{$result[transferTime]}<!--{else}-->{$dateS}<!--{/if}-->"/>(格式：{$dateS})</label>
																	<span id="contract42"><input name="receipt" type="radio" <!--{if $result['receipt']==0}-->checked<!--{/if}--> value="0" id="right102"/><label for="right102">未付款</label></span>
																	</span>
																	<span class="tipPos">
																		<span class="tipLay "></span>
																	</span>
	...
	*/
	...
	$("#postForm").submitForm({ beforeSubmit: '', data: {}, success: function(data){
		if(data.status<1){
			...
			window.location.href='/finance/sale_record.html?act=list';
		}
