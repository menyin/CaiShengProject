									...
									<tr class="">
										...
										<td>
											...
											<!--{if ($company[isCheck]>0)}-->
												...
												该企业被禁用
												<!--{else}-->
												<a class="btn_s" onclick="Boxy.load('company.html?act=follow&cid={$company[cid]}',{title: '企业跟进回访'});">跟进</a>
												<a class="btn_s" onclick="Boxy.iframe('company.html?act=log&cid={$company[cid]}',{title: '企业日志查看',width:700,height:510});">日志</a>
												<a class="btn_s" onclick="Boxy.load('company.html?act=psw&cid={$company[cid]}',{title: '企业密码重置'});">密码</a>
