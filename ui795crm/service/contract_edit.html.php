...
<style type="text/css">
	.cell_tb_list tr td p{font-size: 14px; color: #38599E; font-weight: bold; border-bottom: 1px #ccc solid; line-height: 20px; height: 20px; padding: 5px; margin-bottom: 10px;}
	.cell_tb_list tr td i{font-weight: bold;}
</style>
<body>
<div id="content">
	<!--{template nav}-->
														...
														<table>
															<tr <!--{if $contract[contractId]}--> style="display:none;"<!--{/if}-->>
																...
																<td colspan=3>
																	...
																	<input name="ctype" type="radio" value="10" onclick="change(10);" id="right10" /><label for="right10">襄阳试用会员</label>
																	<div style="height:10px;"></div>
																	<i>2、首页广告+会员：</i>
																	<input name="ctype" type="radio" value="14" onclick="change(14);" id="right14" />
																	<label for="right14">单月会员</label>
																	...
																	<input name="ctype" type="radio" value="11" onclick="change(11);" id="right11" /><label for="right11">全年会员</label>
																	<div style="height:10px;"></div>
																	<i>3、普通会员：</i>
																	<input name="ctype" type="radio" value="21" onclick="change(21);" id="right21" /><label for="right21">普通季度会员</label>
																	<input name="ctype" type="radio" value="22" onclick="change(22);" id="right22" style="display:none;"/><label for="right22" style="display:none;">全年100会员</label>
																	<input name="ctype" type="radio" value="1" onclick="change(1);" id="right1" style="display:none;"/><label for="right1" style="display:none;">全年360会员</label>
																	<input name="ctype" type="radio" value="2" onclick="change(2);" id="right2"/><label for="right2">普通全年会员</label>
																	<input name="ctype" type="radio" value="20" onclick="change(20);" id="right20" style="display:none;"/><label for="right20" style="display:none;">特定全年会员</label>
																	<!--
																	<input name="ctype" type="radio" value="3" onclick="change(3);" id="right3"/><label for="right3">铂金全年会员</label>
																	<input name="ctype" type="radio" value="6" onclick="change(6);" id="right6"/><label for="right6">钻石全年会员</label>
																	<input name="ctype" type="radio" value="9" onclick="change(9);" id="right9"/><label for="right9">特惠全年会员</label>
																	-->
																	<div style="height:10px; border-top:1px #ccc solid; margin-top:10px;"></div>
																	<p>广告（非会员）</p>
																	<i>1、增值首页广告：</i>
																	<input name="ctype" type="radio" value="100" onclick="change(100);" id="right100"/><label for="right100">单月广告</label>
																	<input name="ctype" type="radio" value="101" onclick="change(101);" id="right101"/><label for="right101">两月广告</label>
																	<input name="ctype" type="radio" value="102" onclick="change(102);" id="right102"/><label for="right102">季度广告</label>
																	<input name="ctype" type="radio" value="103" onclick="change(103);" id="right103"/><label for="right103">全年广告</label>
																	<div style="height:10px;"></div>
																	<!--短信
																	{loop $messageProduct $k $l}
																		<input name="ctype" type="radio" value="{$l['pid']}" onclick="getProduct({$k});" id="right100{$l['pid']}"/><label for="right100{$l['pid']}">{$l['productName']}</label>
																	{/loop}-->
																	<!-- 【厦门、泉州】
																	<div style="height:10px;"></div>
															...
															<tr>
																...
																<td><div class="formMod"><span class="formText"><input type="text" class="text" id="txtContract_job" name="txtContract_job" placeholder="" readonly="" value="{$contract[contract_job]}" required="required" onkeyup="this.value=this.value.replace(/[^0-9-]+/,'');"/></span>
																	<span class="tipPos">
																		<span class="tipLay "></span>
																	</span>
																	<div class="clear"></div></div></td>
																<td class="tb_title">简历数：</td>
																<td><div class="formMod"><span class="formText"><input type="text" class="text" id="txtContract_resume" name="txtContract_resume" placeholder="" readonly="" value="{$contract[contract_resume]}" required="required" onkeyup="this.value=this.value.replace(/[^0-9-]+/,'');"/></span>
																	<span class="tipPos">
																		<span class="tipLay "></span>
																	</span>
																	<div class="clear"></div></div></td>
															...
															<tr>
																...
																<td><div class="formMod"><span class="formText"><input type="text" class="text" id="txtContract_sms" name="txtContract_sms" placeholder="" value="{$contract[contract_sms]}" required="required" onkeyup="this.value=this.value.replace(/[^0-9-]+/,'');" readonly=""/></span>
																	<span class="tipPos">
																		<span class="tipLay "></span>
																	</span>
																	<div class="clear"></div></div></td>
																<td class="tb_title">月下载数：</td>
																<td><div class="formMod"><span class="formText"><input type="text" class="text" id="txtContract_month" name="txtContract_month" placeholder="" value="{$contract[contract_month]}" required="required" onkeyup="this.value=this.value.replace(/[^0-9-]+/,'');" readonly="" style="color:gray;" /></span>
																	<span class="tipPos">
																		<span class="tipLay "></span>
																	</span>
																	<div class="clear"></div></div></td>
...
function change(i){
	$('#productType').val(0);//会员
	switch(i)
	{
		case 1:
			$("#txtTitle").val("全年360会员");
			$("#txtContract_job").val(20);
			$("#txtContract_resume").val(500);
			$("#txtContract_sms").val(0);
			$("#txtContract_month").val(500);
		...
		case 3:
			$("#txtTitle").val("铂金全年会员");
			$("#txtContract_job").val(25);
			$("#txtContract_resume").val(3000);
			$("#txtContract_sms").val(0);
			$("#txtContract_month").val(500);
			$("#txtContract_price").val(1500);
			$("#txtEndDate").val('{$nextTime2}');
			break;
		case 4:
			$("#txtTitle").val("特惠全年会员");
		...
		case 6:
			$("#txtTitle").val("钻石全年会员");
			$("#txtContract_job").val(30);
			$("#txtContract_resume").val(5000);
			$("#txtContract_sms").val(0);
			$("#txtContract_month").val(500);
			$("#txtContract_price").val(2000);
			$("#txtEndDate").val('{$nextTime2}');
			break;
		case 7:
			$("#txtTitle").val("钻石三年会员");
			...
			$("#txtContract_sms").val(0);
			$("#txtContract_month").val(500);
			$("#txtContract_price").val(1999);
			$("#txtEndDate").val('{$nextTime3year}');
			break;	
		case 11:
			$("#txtTitle").val("全年会员");
			$("#txtContract_job").val(20);
		...
		case 100:
			$("#txtTitle").val("单月广告");
			$("#txtContract_job").val(0);
			$("#txtContract_resume").val(0);
			$("#txtContract_sms").val(0);
			$("#txtContract_month").val(500);
			$("#txtContract_price").val('');
			$("#txtEndDate").val('{$nextTime30}');
			$('#productType').val(4);//广告
			break;
		case 101:
			$("#txtTitle").val("两月广告");
			$("#txtContract_job").val(0);
...
var productList = "{$messageProductJson}";

function getProduct(id){
	$("#txtTitle").val(productList[id]['productName']);
	$("#txtContract_job").val(productList[id]['jobNum']);
	$("#txtContract_resume").val(productList[id]['resumeNum']);
	$("#txtContract_sms").val(productList[id]['messageNum']);
	$("#txtContract_month").val(productList[id]['monthDownload']);
	$("#txtContract_price").val(productList[id]['price']);
	$("#txtEndDate").val(productList[id]['time']);
	$('#productType').val(1);//短信
}
</script>
<script type="text/javascript">
function sub (status) {
	...
	if($('#txtTitle').val() == ''|| typeof($('#txtTitle').val()) == 'undefined'||strlen($('#txtTitle').val())>24){
		alert('请输入1-8个字标题！');
		return;
	}
	...
	if($('#txtContract_month').val() == ''||typeof($('#txtContract_month').val()) == 'undefined'||$('#txtContract_month').val() == 0){
		alert('请输入月下载数！');
		return;
	}
