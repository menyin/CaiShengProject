	...
	<div id="contentBody" style="visibility: visible;">
		...
		<div class="content" style="">
			<div id="main" class="security-groups" style="">
				<div class="title">
					<div class="m_bg">客服管理 >  <a href="contract.html?act=comlist&op=all&c_id={$_cid}">公司：[{$com[cname]}] 合同总列表</a> ><a href="contract.html?act=comlist&op=all&c_id={$_cid}"> 合同：[{$contract[title]}] </a> > 合同升级</div>
				</div>
				<div class="quickbar">
										...
										<div class="apply">
											<div class="apply_1">
												...
												<form id="postForm" name="postForm" method="post" action="contract.html">
													<input type="hidden" name="act" id="act" value="sjsave" />
													...
													<div class="cell_tb_list">
														<table>
															...
															<tr>
																...
																<td colspan=3><div class="formMod addressMod">
																	<select id="cityid" name="cityid" onchange="selectcity();" class="drop" style="width: 160px;" required="required" message="请选择所属的站点">
																		...
																		<option value="{$region1[region_id]}" <!--{if $contract[contractId] || $parent_id}--> disabled <!--{/if}-->  <!--{if $region1[region_id]==$cityid }--> selected <!--{/if}-->>{$region1[region_name_full]}</option>
																		<!--{/loop}-->
																	</select>
															...
															<tr>
																...
																<td><div class="formMod"><span class="formText"><input type="text" class="text" id="txtStartDate" name="txtStartDate" placeholder="" value="{$contract[startDate]}" required="required" readonly="readonly" style="color:gray;"/></span>
																	<span class="tipPos">
																		<span class="tipLay "></span>
																	</span>
																	<div class="clear"></div></div></td>
																<td class="tb_title">结束时间：</td>
																<td><div class="formMod"><span class="formText"><input type="text" class="text" id="txtEndDate" name="txtEndDate" placeholder="" value="{$contract[endDate]}" required="required" readonly="readonly" style="color:gray;"/></span>
																	<span class="tipPos">
																		<span class="tipLay "></span>
																	</span>
																	<div class="clear"></div></div></td>
