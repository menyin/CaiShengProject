	...
	<div id="contentBody" style="visibility: visible;">
		...
		<div class="content" style="">
			<div id="main" class="security-groups" style="">
				<div class="title">
					<div class="m_bg">客服管理 >查看企业： [<a href="http://www.{ROOT_DOMAIN}/com-{$com[_cid]}/" target="_blank">{$com['cname']}]</a> >基本资料</div>
				</div>
				<div class="quickbar">
					...
					<div class="btns">
						<div class="btn-line clearfix">
							...
							<a href="/companyinfo/companyinfo.html?act=advs&c_id={$com['_cid']}"><div class="btn icon-4 icon" >广告位管理</div></a>
