	...
	<div id="contentBody" style="visibility: visible;">
		...
		<div class="content" style="">
			<div id="main" class="security-groups" style="">
				<div class="title">
					<div class="m_bg">客服管理 > 职位审核 > {$thisTitle}</div>
				</div>
				<div class="quickbar">
					...
					<div class="main_content">
						...
						<div class="cell_tb_list">
							<table class="has_checkbox">
								...
								<tbody>
									<tr class="">
										<td class="td1"><input type="checkbox"  name="chkId[]"  onclick="chk()" class="c2_checkbox" value="{$job[jid]}" ></td>
										<td><a href="http://www1.597.com/job-{$job[_jid]}.html" target="_blank">{$job[jname]}</a></td>
										<td><a href="http://www1.597.com/com-{$job[_cid]}/" target="_blank">{$job[cname]}</a> ({$job[username]})</td>
										<td>{$job[jobArea]}</td>
										<td>{$job[modTime]}</td>
										<td>{$job[_isCheck]}</td>
										<td>
											<!--{if ($job[isCheck]==0)}-->
											<a class="btn_s" href="check_job.html?act=check_ok&cid={$job[cid]}&jid={$job[jid]}">通过</a>
											<a class="btn_s" href="check_job.html?act=check_no&cid={$job[cid]}&jid={$job[jid]}">屏蔽</a>
											<!--{else}-->
												<!--{if ($job[isCheck]==1)}-->
												<a class="btn_s" href="check_job.html?act=check_no&cid={$job[cid]}&jid={$job[jid]}">屏蔽</a>
												<!--{/if}-->
