			...
			<div id="main" class="security-groups" style="">
							...
							<div class="location_main item">
								<ul style="width:900px \9; *width:900px; _width:900px; ">
									...
									<li class="ml_10">排序方式：<select id="ordertype" name="ordertype" style="width:80px">
										...
										<option value="5" <!--{if $ordertype=='5'}-->selected<!--{/if}-->>只显示点单</option>
				...
				<div class="mainContent" style="">
					<div class="main_content">
						<form name="listform" action="/xuyue/joinM.html" method="post" >
									...
									<tr class="">
										...
										<td>
											<div style="display:inline-block;">
												...
												<a class="btn_s" href="/xuyue/company.html?act=follow&c_id={$company[_cid]}" target="_blank">跟进</a>
												<!--{if !$company[adminId]}-->
