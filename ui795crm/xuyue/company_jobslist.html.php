	...
	<div id="contentBody" style="visibility: visible;">
		...
		<div class="content" style="">
			<div id="main" class="security-groups" style="">
				<div class="title">
					<div class="m_bg">客服管理 >查看企业： [<a href="http://www.{ROOT_DOMAIN}/com-{$com[_cid]}/" target="_blank">{$com['cname']}]</a> >招聘的职位</div>
				</div>
				<div class="quickbar">
															...
															<tr>
																<td width="103" class="tb_title" >
																	<ul>
																		...
																		<!--{loop $jobListAll $l}-->
																			<!--{loop $l['list'] $ll}-->
																				<li><a href="/companyinfo/companyinfo.html?act=jobinfo&c_id={$com['_cid']}&id={$ll['jid']}">{$ll['jname']}</a></li>
																			<!--{/loop}-->
																		<!--{/loop}-->
																	</ul>
																</td>
