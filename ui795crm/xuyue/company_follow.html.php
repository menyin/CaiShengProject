	...
	<div id="contentBody" style="visibility: visible;">
		...
		<div class="content" style="">
			<div id="main" class="security-groups" style="">
				<div class="title">
					<div class="m_bg">续约管理 > 我的企业 > 企业跟进</div>
				</div>
				<div class="quickbar">
							...
							<div class="mod_pool">
								<div class="summary">
									<div class="apply_main">
										<div class="apply">
											<div class="apply_1">
												<form id="postForm" name="postForm" method="post" action="/xuyue/company.html">
													...
													<div class="cell_tb_list">
														<table style="margin-top: 0px;">
															<tr>
																...
																<td width="85%"><span style="float:left;"><b>{$com[cname]}</b>&nbsp;&nbsp;&nbsp;<!--{if $com[comUser] || $com[comPhone] || $com[comMobile]}-->(联系人：{$com[comUser]}；联系电话：{$com[comPhone]}；联系手机：{$com[comMobile]})<!--{/if}-->&nbsp;&nbsp;&nbsp;&nbsp;</span><a class="btn_s"  href="/companyinfo/companyinfo.html?act=view&c_id={$com['_cid']}" target="_blank">查看详情</a>
																</td>
															</tr>
										...
										<iframe src="/xuyue/company.php?act=followView&c_id={$com[_cid]}" width="100%" height="500" frameborder=0 style="cell_tb_list"></iframe>
									</div>
								</div>
							</div>
						</div>
