						...
						<tbody>
							<tr>
								...
								<table width="735" border="0" cellspacing="0" cellpadding="0">
									<tbody>
										<tr>
											<td align="center" valign="bottom" style="padding-right:10px;"><!--<input type="button" name="Submit3" value="打印简历" onClick="window.open('Resume_Print.shtml?param=')">
											<input type="submit" name="Submit4" value="关闭窗口" onClick="window.close();"> -->
											<input type="button" name="noflag" value="取消审核" onclick="Boxy.load('isCheckNo.html?r_id={$resume[$key][_rid]}&key={$key}',{title: 	'不通过理由'});">
											<input type="button" name="flag" value="通过审核" onClick="javascript:theForm_Submit('{$resume[$key]['_rid']}',1,'{$key}')"></td>
