							...
							<table class="has_checkbox">
								...
								<tbody data-bind="foreach: items">
									<tr class="">
										...
										<td>
											<a class="btn_s" href="person.html?act=edit&pid={$result[pid]}">修改</a>
											<!--{if $result[endDate]<$time}-->
												<a class="btn_s" href="dispatch.html?act=edit&pid={$result[pid]}">派遣</a>
												<a class="btn_s" href="person.html?act=delete&pid={$result[pid]}" onclick="return confirm('确认需要删除些信息吗？');">删除</a>
											<!--{/if}-->
										</td>
									</tr>
								</tbody>
