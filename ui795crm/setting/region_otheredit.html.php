								...
								<div class="summary">
									<div class="apply_main">
										<div class="apply">
											<div class="apply_1">
												<div class="">
												<form id="postForm" name="postForm" method="post" action="region.html">
													<input type="hidden" name="act" id="act" value="othersave" />
													...
													<div class="cell_tb_list">
														<table style="margin-top: 0px;">
															...
															<tr>
																...
																<td>{$region[region_name_short]}</td>
															</tr>
															<tr>
															...
															<tr>
																...
																<td>{$region[region_site]}</td>
															</tr>
															<tr>
																<td class="tb_title">页面内容：</td>
																<td>
																	<!--{if $op == 'footer'}-->
																		<textarea name="content" cols="150" rows="20">{$region[content]}</textarea>
																	<!--{else}-->
																		<!-- <textarea name="content" cols="150" rows="20">{$region[content]}</textarea> -->
																		<script id="editor" name="content" type="text/plain" style="width:1024px;height:500px;">{$region[content]}</script>
																	<!--{/if}-->
												...
												<div class="apply_btn_next">
													<div class="apply_btn_bg">
														<a class="apply_1_next" onclick="document.postForm.submit();">完成</a>
													</div>
												</div>
											</div>
										</div>
