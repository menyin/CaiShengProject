	...
	<div id="contentBody" style="visibility: visible;">
		...
		<div class="content" style="">
			<div id="main" class="security-groups" style="">
				<div class="title">
					<div class="m_bg">站点管理 > 公告设置</div>
				</div>
				<div class="quickbar">
					<div class="note">小贴士</div>
					<div class="btns">
						<div class="btn-line clearfix">
							<div class="btn icon-1 icon"><a href="gg.html?act=edit">新增公告</a></div>
			            ...
			            <div class="location">
			                <div class="location_main item">
			                    <ul>
			                        ...
			                        <li>　模糊查询：<input type="text" name="query" id="query" class="search input_txt" placeholder="公告标题"></li>
			                        <li class="ml_10">
										...
										<div style="float:left;">每页
											<select onchange="window.location.href=$(this).val();">
												<!--{loop $__ppStr $key $value}-->
													<option value="gg.html?act=list{$value}" <!--{if $pp==$key}-->selected<!--{/if}-->>{$key}</option>
												<!--{/loop}-->
							...
							<table class="has_checkbox">
								...
								<tbody data-bind="foreach: items">
									<tr class="">
										...
										<td>{$gg[createTime]}</td>
										<td>
											<a class="btn_s" href="gg.html?act=mod&gid={$gg[gid]}">修改公告</a>
