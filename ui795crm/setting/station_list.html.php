	...
	<div id="contentBody" style="visibility: visible;">
		...
		<div class="content" style="">
			<div id="main" class="security-groups" style="">
				<div class="title">
					<div class="m_bg">站点管理 > 公交站台总列表</div>
				</div>
				<div class="quickbar">
					<div class="note">小贴士</div>
					<div class="btns">
						<div class="btn-line clearfix">
							<div class="btn icon-1 icon" ><a href="station.html?act=edit">新增公交站台</a></div>
										...
										<div style="float:left;">每页
											<select onchange="window.location.href=$(this).val();">
												<!--{loop $__ppStr $key $value}-->
													<option value="station.html?cityId={$_GET['cityId']}&act=list{$value}" <!--{if $pp==$key}-->selected<!--{/if}-->>{$key}</option>
												<!--{/loop}-->
											</select>条  共{$stationList['count']}条
										</div>
							...
							<table class="has_checkbox">
								<thead>
									<tr class="table_header">
										<th width="6%">城市名</th>
										<th width="8%">公交站台</th>
										<th width="8%">公交站台经度</th>
										<th width="8%">公交站台维度</th>
										<th width="6%">方向</th>
										<th width="15%">操作</th>
									</tr>
								</thead>
								...
								<tbody data-bind="foreach: items">
									<tr class="">
										...
										<td>
											<a class="btn_s" href="station.html?act=edit&id={$val['id']}">修改</a>
