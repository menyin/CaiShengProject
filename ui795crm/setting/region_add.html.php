										...
										<div class="apply">
											<div class="apply_1">
												...
												<form id="postForm" name="postForm" method="post">
													...
													<input type="hidden" name="region[sort_order]" id="sort_order" value="255" />
													...
													<div class="cell_tb_list">
														<table style="margin-top: 0px;">
															<tr>
																...
																<td><input type="text" class="text1" id="region_id" name="region[region_id]" placeholder="例子：1100" value="{$region[region_id]}"/></td>
															</tr>
															<tr>
															...
															<tr>
																<td class="tb_title" width="140px">级别：</td>
																<td><input type="text" class="text1" name="region[region_type]" placeholder="例子：3" value="{$region[region_type]}"/></td>
															</tr>
															<tr>
																<td class="tb_title">区域全名称：</td>
																<td><input type="text" class="text1" id="region_name_full" name="region[region_name_full]" placeholder="例子：北京市" value="{$region[region_name_full]}"/></td>
															</tr>
															<tr>
															...
															<tr>
																<td class="tb_title">标注：</td>
																<td><input type="text" class="text1" name="region[region_name_sort]" placeholder="例子：北京" value="{$region[region_name_sort]}"/></td>
															</tr>
															<tr>
																<td class="tb_title">父ID：</td>
																<td><input type="text" class="text1" name="region[parent_id]" placeholder="例子：1" value="{$region[parent_id]}"/></td>
															</tr>
															<tr>
												...
												<div class="apply_btn_next">
													<div class="apply_btn_bg">
														<a class="apply_1_next"  onclick="sub();">下一步</a>
													</div>
												</div>
											</div>
										</div>
...
function sub (status) {
	...
	if($('#region_name_full').val() == ''|| typeof($('#region_name_full').val()) == 'undefined'){
		alert('请输入站点地区！');
		return;
	}
	$("#postForm").submitForm({ beforeSubmit: '', data: {}, success: function(data){
		if(data.status<1){
			...
			window.location.href='/setting/region.html?act=list';
		}
