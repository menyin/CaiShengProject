	...
	<div id="contentBody" style="visibility: visible;">
		...
		<div class="content" style="">
			<div id="main" class="security-groups" style="">
				<div class="title">
					<div class="m_bg">查看企业： [<a href="http://www.{ROOT_DOMAIN}/com-{$com[_cid]}/" target="_blank">{$com['cname']}]</a> >执照基本信息</div>
				</div>
				<div class="quickbar">
											...
											<div class="apply_1">
												...
												<form id="postForm" name="postForm" method="post">
													...
													<table style="margin-top: 0px;">
														<!--{if is_array($licence) && $com[licenceCheck]==1}-->
														<tbody>
															<tr class="hover">
														...
														<tbody>
															<tr class="hoverout">
																<td class="tb_title" colspan="4">执照审核不通过</td>
															</tr>
															<tr class="hoverout">
																<td class="tb_title" colspan="4">不通过原因：{$licence[reply]}</td>
															</tr>
															<tr class="hover">
																<td width="112" rowspan="7" class="tb_title">营业执照：</td>
																<td width="184" rowspan="7"><a href="{$licence[licenceurl]}" target="_blank"><img src="{$licence[licenceurl]}" height="300"></a></td>
