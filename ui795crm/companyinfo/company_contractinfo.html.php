	...
	<div id="contentBody" style="visibility: visible;">
		...
		<div class="content" style="">
			<div id="main" class="security-groups" style="">
				<div class="title">
					<div class="m_bg">查看企业： [<a href="http://www.{ROOT_DOMAIN}/com-{$com[_cid]}/" target="_blank">{$com['cname']}]</a> >合同管理</div>
				</div>
				<div class="quickbar">
													...
													<!--{if $list}-->
														...
														<table width="1023" height="100">
															...
															<tr>
																...
																<td width="152">{$product[_jobNum]}/{$product[jobNum]}</td>
																<td width="109">简历数：</td>
																<td width="119">{$product[_resumeNum]}/{$product[resumeNum]}</td>
																<td class="tb_title">短信数：</td>
																<td width="196">{$product[_messageNum]}/{$product[messageNum]}</td>
																<td width="106">月下载数：</td>
																<td width="119">{$product['_monthDownload']}</td>
															</tr>
															<tr>
																<td height="40" class="tb_title">付款金额：</td>
																<td colspan="7"><span class="strong">{$product['contract_price']}元</span></td>
															</tr>															
														</table>
														<!--{/loop}-->
													<!--{else}-->
