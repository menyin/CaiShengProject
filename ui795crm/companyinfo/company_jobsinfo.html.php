...
<style type="text/css">
	tr td .jobKeyword{position: relative; top:5px;float: left; margin-right: 10px;}
</style>
<!--{template header}-->
															...
															<td width="1041">
																<table width="963" height="80" border="1">
																	<tr>
																		...
																		<td>{$job['jname']}&nbsp;</td>
																		<td>关键词：</td>
																		<td><span class="jobKeyword">{$job['jobKeyword']}</span>&nbsp;<a href="javascript:void(0)" class="btn_s" id="jobkeyword">添加/更新</a></td>
																	</tr>
																	<tr>
																		<td>招聘人数：</td>
...
<script type="text/javascript">
	$("#jobkeyword").click(function(){
		var jid = "{$id}",
			cid = "{$com['cid']}",
			word = "{$job['jobKeyword']}";
		$.showModal('/companyinfo/companyinfo.html?act=job_keyword&jid='+jid+'&cid='+cid+'&word='+word,{title:'职位关键词'});
	})
</script>
</body>
</html>