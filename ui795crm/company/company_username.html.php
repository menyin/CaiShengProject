<form id="postForm" method="post" action="/company/company.html" onsubmit="return false;">
	<input type="hidden" name="act" id="act" value="save_username" />
		...
		<div class="step_1 step_2 step_left">
			<table>
				...
				<tr>
					...
					<td class="td2" colspan="2">
						<input type="text" class="text1" name="newusername" />
					</td>
				</tr>
			</table>
		</div>
