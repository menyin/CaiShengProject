...
<style>
	.step_submit_btn span{margin-right: 100px; font-size: 14px;color: #f00;}
				...
				<div class="quickbar">
					...
					<div class="btns">
						<div class="btn-line clearfix">
							<b>公司名称：</b><a href="http://www.{ROOT_DOMAIN}/com-{$_cid}/" target="_blank">{$licence[_cname]}</a>&nbsp;&nbsp;&nbsp;<a href="/companyinfo/companyinfo.html?act=view&c_id={$_cid}" target="_blank">查看详情</a>
											...
											<div class="apply_1">
												<form id="postForm" name="postForm" method="post">
													...
													<div class="cell_tb_list">
														<table style="margin-top: 0px;">
															<tbody>
																...
																<tr class="hover">
																	<td height="53">所在地区：</td>
																	<td colspan="2">{$licence['_comCityId']}&nbsp;</td>
															    </tr>
																<tr class="hover">
																...
																<tr class="hoverout" id="licenceList">
																	<td colspan="4">
																		<div>1.<span>未通过认证，您上传的营业执照太模糊，请重新上传清晰且完整的最新营业执照（副本），以便通过认证，谢谢！</span></div>
																		<div>2.<span>未通过认证，您上传的营业执照不完整，请重新上传清晰且完整的最新营业执照（副本），以便通过认证，谢谢！</span></div>
																		<div>3.<span>未通过认证，您上传的执照名称与网站名称不一致，请重新上传与网站名称一致的营业执照副本或联系客服更改网站企业名称，以便通过认证，谢谢！</span></div>
																		<div>4.<span>未通过认证，您上传的是营业执照（正本），请重新上传营业执照（副本）或者追加上传（信用代码证、开户许可证）其中一样，以便通过认证，谢谢！</span></div>
																		<div>5.<span>未通过认证，您上传的营业执照未加盖企业公章，请重新上传清晰且完整的最新营业执照（副本）并加盖企业公章，以便通过认下，谢谢！</span></div>
																		<div>6.<span>未通过认证，您上传的是个体工商户执照（正本），请重新上传个体工商户执照（副本）或者追加上传（法人身份证、信用代码证、开户许可证）其中一样，以便通过认证，谢谢！</span></div>
																		<div>7.<span>未通过认证，您上传的非营业执照副本，请重新上传清晰且完整的最新营业执照（副本）并加盖企业公章，以便通过认证，谢谢！ </span></div>
																		<div>8.<span>未通过认证，贵公司营业执照已变更，请重新上传清晰且完整的于***变更后的营业执照（副本），以便通过认证，谢谢！</span></div>
																		<div>9.<span>未通过认证，您上传的营业执照尺寸太小，请重新上传清晰且完整的最新营业执照（副本），建议宽度尺寸800像素以上，以便通过认证，谢谢！</span></div>
																		<div>10、<span>未通过认证，该公司已有认证帐号！一张执照只能认证一个帐号，谢谢！</span></div>
																	</td>
																</tr>
																<tr class="hoverout">
													...
													<div class="step_submit_btn">
														...
														<span>提示：{$companyNote['note']}</span>
														<a class="tg_btn" id="btnSave" onclick="aa(1);">通过</a>
														<a id="btn" onclick="aa(-2);">屏蔽</a>
													</div>
													<!--{if $op==ischeck}-->
														<div id="frame"  style="margin-top: 10px;">
															<iframe scrolling="auto" src="check_licence.php?act=unique&query='{$licence[_cname]}'&now_cid={$c_id}" width="100%" height="230" frameborder=0></iframe>
														</div>
													<!--{/if}-->
												</form>
											</div>
...
function aa (check) {
	...
	$("#postForm").submitForm({ beforeSubmit: '', data: {}, success: function(data){
		if(data.status<1){
			...
			window.location.href = "check_licence.html?act=list&op={$op}&query_day={$query_day}&query={$q}&page={$page}";
		}
...
$(document).ready(function(){
	$('#licenceList div').click(function(){
		$("#reply").val($(this).find('span').html());
	});
	// 解决 ie6 select框 问题
