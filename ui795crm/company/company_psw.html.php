<form  id="postForm" name="postForm" method="post" action="/company/company.html" onsubmit="return false;">
	...
	<div class="step_submit_btn">
		<button type="button" name="step1_submit" class="step1_submit submit_btn_ok" id="step1_submit" onClick="sub();"></button>
	</div>
</form>
