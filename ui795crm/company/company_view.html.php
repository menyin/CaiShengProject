	...
	<div id="contentBody" style="visibility: visible;">
		...
		<div class="content" style="">
			<div id="main" class="security-groups" style="">
				<div class="title">
					<div class="m_bg">企业审核 >查看企业： [<a href="http://www.{ROOT_DOMAIN}/com-{$com[_cid]}/" target="_blank">{$com['cname']}]</a> >基本信息</div>
				</div>
				<div class="quickbar">
					<div class="note">小贴士</div>
					<div class="btns">
						<div class="btn-line clearfix">
							<a href="/companyinfo/companyinfo.html?act=view&c_id={$com['_cid']}"><div class="btn icon-7 icon" id="btns-cur">基本资料</div></a>
											...
											<div class="apply_1">
												...
												<form id="postForm" name="postForm" method="post">
													...
													<table style="margin-top: 0px;">
														...
														<tr>
															<td>会员级别:</td>
															<td colspan="3"><!--{if $isVip}-->VIP<!--{else}-->未开通会员<!--{/if}--><!--{if $isVip}-->&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a style="text-decoration:underline" href="/companyinfo/companyinfo.html?act=contract&c_id={$com['_cid']}">合同管理</a><!--{/if}--></td>
														</tr>
														<tr>
															<td>注册时间：</td>
															<td>{$com[regTime]}&nbsp;</td>
														...
														<tr>
															<td>与本站联系人：</td>
															<td>{$com[User597]}&nbsp;<label style="margin-left:20px;"><a style="text-decoration:underline" onclick="Boxy.load('company.html?act=lianxi&c_id={$com['_cid']}',{title: '与本站联系修改'});" >修改</a> </label></td>
															<td>与本站联系电话：</td>
															<td>{$com[Phone597]}&nbsp;<label style="margin-left:20px;"><a style="text-decoration:underline" onclick="Boxy.load('company.html?act=lianxi&c_id={$com['_cid']}',{title: '与本站联系修改'});" >修改</a></label></td>
														</tr>
														<tr>
															<td>与本站联系手机：</td>
