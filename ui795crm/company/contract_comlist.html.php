	...
	<div id="contentBody" style="visibility: visible;">
		...
		<div class="content" style="">
			<div id="main" class="security-groups" style="">
				<div class="title">
					<div class="m_bg">企业其他管理 > 企业搜索 >  公司：[{$com[cname]}] 合同管理</div>
				</div>
				<div class="quickbar">
						...
						<div class="location">
							<div class="location_main item">
								<ul>
									...
									<input type="hidden" name="_q" value="{$_query}">
										...
										<div style="float:left;">每页
											<select onchange="window.location.href=$(this).val();">
												<!--{loop $__ppStr $key $value}-->
													<option value="contract.html?act={$act}&op={$op}&c_id={$_cid}&_ordertype={$_ordertype}&_q={$_query}&_page={$_page}&query={$q}{$value}" <!--{if $pp==$key}-->selected<!--{/if}-->>{$key}</option>
												<!--{/loop}-->
						...
						<div class="cell_tb_list">
							...
							<thead>
									<tr class="table_header">
										...
										<th width="30px" style="display:none;">合同编号</th>
										...
										<th width="25px">职位数</th>
										<th width="25px">简历数</th>
										<th width="25px">短信数</th>
										<th width="25px">月下载数</th>
										<th width="30px">状态</th>
										<th width="50px">操作</th>
									</tr>
								</thead>
