...
(function($)
{
	...
	$.extend($.validator, {
		...
		messages: {
			...
			username: "Please enter a value with a valid extension.",
		...
		methods: {
			...
			{
				return this.optional(element) || /^13[0-9]{9}|15[0|1|2|3|5|6|7|8|9]\d{8}|18[0|5|6|7|8|9]\d{8}$/i.test(value);
				return this.optional(element) || /^(((13[0-9]{1})|(15[0-9]{1}))+\d{8})$/i.test(value);
			},
