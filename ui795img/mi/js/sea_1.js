...
jobcn.Person = jobcn.Person || {}
//上面是为了兼容www.jobcn.com
window.my = {
  cache :{}
  ,path : "/mi/"
  ,ui : {z_index:0}
  ,debug : true
  ,logs : []
  ,log : function(name,msg){ if(this.debug){var a = {};a[name] = msg;a[name+"_runtime"] = new Date().getTime();this.logs.push(a);}}
  ,v : ""
  ,min : true
}
try{
  (function(){
    var el = document.getElementById('firstSeajs')
    my.v = el.getAttribute('data-v') || ""
    my.min = /min/.test(el.getAttribute('src'))
  })()
}catch(e){
}

(function(){
  if (/(\?|&)debug=qianduan&?/.test(window.location.search)) my.min = false
})()

my.alias = {
  "weixin":location.protocol+"//res.wx.qq.com/open/js/jweixin-1.0.0.js",
  "zepto": "zepto.js"
  ,"juicer" : "juicer.js"
  ,"$" : "$.js"
  ,"area" : "../../data/area.js"
  ,"position" : "../../data/post.js"
  ,"industry" : "../../data/industry.js"
  ,"swiper" : "swiper.js"
  ,"iscroll-lite" : "iscroll-lite.js"
  ,"util" : "util.js"
  ,"ui.base" : "ui.base.js"
  ,"ui.mBox" : "ui.mBox.js"
  ,"ui.mEditor" : "ui.mEditor.js"
  ,"ui.popFloat" : "ui.popFloat.js"
  ,"ui.sideBox" : "ui.sideBox.js"
  ,"ui.selector" : "ui.selector.js"
  ,"ui.selector2" : "ui.selector2.js"
  ,"ui.linkSelect" : "ui.linkSelect.js"
  ,"ui.touchSilder" : "ui.touchSilder.js"
  ,"sendCode" : "sendCode.js"
  ,"ui.iosSelect" : "ui.iosSelect.js"
  //业务代码
  ,"ui.data.area" : "../../../data/ui.data.area.js"
  //,"ui.data.area" : "/api.html?act=miAreaList&"
  //,"ui.data.area": "http://m.jobcn.com/touch/public/jslib/data/areaLinkSelect.json?2016-02-19"
  ,"resume.lang" : "action/resume.lang.js"
  ,"action.hr" : "action/hr.js"
  ,"action.index" : "action/index.js"
  ,"action.detail" : "action/detail.js"
  ,"action.position.detail" : "action/position.detail.js"
  ,"action.result" : "action/result.js"
  ,"action.login" : "action/login.js"
  ,"action.register" : "action/register.js"
  ,"action.person" : "action/person.js"
  ,"action.person.searcher" : "action/person.searcher.js"
  ,"action.person.resume" : "action/person.resume.js"
  ,"action.person.resume.create" : "action/person.resume.create.js"
  ,"action.person.resume.myResumes" : "action/person.resume.myResumes.js"
  ,"action.person.resume.getSubResume" : "action/person.resume.getSubResume.js"
  ,"action.person.resume.preview" : "action/person.resume.preview.js"
  ,"action.person.resume.photo" : "action/person.resume.photo.js"
  ,"action.person.resume.base" : "action/person.resume.base.js"
  ,"action.person.resume.apply" : "action/person.resume.apply.js"
  ,"action.person.resume.education" : "action/person.resume.education.js"
  ,"action.person.resume.school": "action/person.resume.school.js"
  ,"action.person.resume.major" : "action/person.resume.major.js"
  ,"action.person.resume.train" : "action/person.resume.train.js"
  ,"action.person.resume.practice" : "action/person.resume.practice.js"
  ,"action.person.resume.work" : "action/person.resume.work.js"
  ,"action.person.resume.project" : "action/person.resume.project.js"
  ,"action.person.resume.ability" : "action/person.resume.ability.js"
  ,"action.person.resume.language" : "action/person.resume.language.js"
  ,"action.person.resume.self" : "action/person.resume.self.js"
  ,"action.person.resume.award" : "action/person.resume.award.js"
  ,"action.person.resume.certificate" : "action/person.resume.certificate.js"
  ,"action.person.blackList":"action/person.blackList.js"
  ,"action.person.modifyInfo":"action/person.modifyInfo.js"
  ,"action.resume.apply.history":"action/resume.apply.history.js"
  ,"action.resume.apply.favorite":"action/resume.apply.favorite.js"
  ,"action.resume.apply.invite":"action/resume.apply.invite.js"
  ,"action.resume.apply.sendout":"action/resume.apply.sendout.js"
  ,'action.person.resume.cert':'action/person.resume.cert.js'
  ,'action.person.resume.otherInfo':'action/person.resume.otherInfo.js'
  ,"action.person.resume.setup":"action/person.resume.setup.js"
  ,"action.person.resume.myletter":"action/person.resume.myletter.js"
  ,"action.person.message":"action/person.message.js"
  ,"action.resume.apply.viewedLog":"action/resume.apply.viewedLog.js"
  ,"person.contact.us":"action/person.contact.us.js"
  ,"action.person.getpassword":"action/person.getpassword.js"
  ,"action.info":"action/info.js"
  ,"action.ce":"action/ce.js"
  ,"action.zph":"action/recruitment.gdst.js"
  ,"action.dgut": "action/recruitment.dgut.js"
  ,"action.hotjob": "action/recruitment.hotjob.js"
  ,"action.company.recruit.page":"action/company.recruit.page.js"
  ,"action.about.company":"action/about.company.js"
  ,"action.person.login":"action/person.login.js"
  ,"action.person.register":"action/person.register.js"
  ,"person.about":"action/person.about.js"
  ,"action.1" : "action/1.js"
}
/**
...
seajs.config({
  alias: function(){
    for(var nam in my.alias){
      my.alias[nam] = my.alias[nam] +"?"+my.v ;
    }
    return my.alias
  }()
  ,debug : false
...
//系统依赖项 --放在此处减少HTTP请求
define("seajs/plugin-base",[],function(m,k){var l=seajs.pluginSDK,i=l.util,h=l.Module,g={},j={};k.add=function(b){g[b.name]=b};k.util={xhr:function(b,a){var c=window.ActiveXObject?new window.ActiveXObject("Microsoft.XMLHTTP"):new window.XMLHttpRequest;c.open("GET",b,!0);c.onreadystatechange=function(){if(4===c.readyState)if(200===c.status)a(c.responseText);else throw Error("Could not load: "+b+", status = "+c.status);};return c.send(null)},globalEval:function(b){b&&/\S/.test(b)&&(window.execScript||function(a){window.eval.call(window,a)})(b)}};(function(){var b=h._resolve;h._resolve=function(a,c){var d,e;if(e=a.match(/^(\w+)!(.+)$/))d=e[1],a=e[2];a="#"+i.parseAlias(a);if(!d&&(e=a.match(/[^?]*(\.\w+)/))){e=e[1];for(var f in g)if(g.hasOwnProperty(f)&&-1<i.indexOf(g[f].ext,e)){d=f;break}}d&&!/\?|#$/.test(a)&&(a+="#");f=b(a,c);d&&(g[d]&&!j[f])&&(j[f]=d);return f}})();(function(){var b=h._fetch;h._fetch=function(a,c,d){var e=j[i.unParseMap(a)];e?g[e].fetch(a,c,d):b(a,c,d)}})()});
//系统依赖项 --放在此处减少HTTP请求
define("seajs/plugin-debug",[],function(){var g=seajs.pluginSDK.util;var h=this.location;var m=h.search;var c=l();if(m.indexOf("seajs-debug")>-1){c.debug=1;c.console=1;b(c)}if(c.mapfile){document.title="[seajs debug mode] - "+document.title;seajs.config({preload:c.mapfile})}seajs.use=seajs._use;delete seajs._use;var j=seajs._useArgs;if(j){for(var e=0;e<j.length;e++){seajs.use(j[e][0],j[e][1])}delete seajs._useArgs}if(c.console){d(c.mapfile)}if(m.indexOf("firebug-lite")>-1){g.fetch("https://getfirebug.com/firebug-lite.js")}function d(p){var n="#seajs-debug-console {   position: fixed; bottom: 10px;   *position: absolute; *top: 10px; *width: 465px;   right: 10px; z-index: 999999999;  background: #fff; color: #000; font: 12px arial;  border: 2px solid #000; padding: 0 10px 10px;}#seajs-debug-console h3 {  margin: 3px 0 6px -6px; padding: 0;  font-weight: bold; font-size: 14px;}#seajs-debug-console input {  width: 400px; margin-left: 10px;}#seajs-debug-console button {  float: right; margin: 6px 0 0 10px;  box-shadow: #ddd 0 1px 2px;  font-size: 14px; padding: 4px 10px;  color: #211922; background: #f9f9f9;  text-shadow: 0 1px #eaeaea;  border: 1px solid #bbb; border-radius: 3px;  cursor: pointer; opacity: .8}#seajs-debug-console button:hover {  background: #e8e8e8; text-shadow: none; opacity: 1}#seajs-debug-console a {  position: relative; top: 10px; text-decoration: none;}";var i='<div id="seajs-debug-console">  <h3>SeaJS Debug Console</h3>  <label>Map file: <input value="'+p+'"/></label><br/>  <button>Exit</button>  <button>Hide</button>  <button>Refresh</button></div>';var q=document.createElement("div");q.innerHTML=i;seajs.importStyle(n);k(q);var o=q.getElementsByTagName("button");o[1].onclick=function(){c.console=0;b(c);h.replace(h.href.replace("seajs-debug",""))};o[2].onclick=function(){var r=q.getElementsByTagName("input")[0].value||"";if(r){r=g.id2Uri(r)}c.mapfile=r;b(c);h.reload()};o[0].onclick=function(){c.debug=0;b(c);h.replace(h.href.replace("seajs-debug",""))}}function l(){var n="",i;if((i=document.cookie.match(/(?:^| )seajs-debug(?:(?:=([^;]*))|;|$)/))){n=i[1]?decodeURIComponent(i[1]):""}var o=n.split("`");return{debug:Number(o[0])||0,mapfile:o[1]||"",console:Number(o[2])||0}}function b(n){var i=new Date();i.setTime(i.getTime()+30*86400000);document.cookie="seajs-debug="+n.debug+"`"+n.mapfile+"`"+n.console+"; path=/; expires="+i.toUTCString()}var a=100;var f=0;function k(i){f++;if(document.body){document.body.appendChild(i)}else{if(f<a){setTimeout(function(){k(i)},200)}}}});
//系统依赖项 --放在此处减少HTTP请求
