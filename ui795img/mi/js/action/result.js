            ...
            industryClick : function(){
                var selector = new uiSelector({
                        ...
                        ,onSave : function (s) {
                            ...
                            calling = s.OPTIONS.selectedItemsId;
                            callingNames = s.OPTIONS.selectedItemsText;
                            // window.location = "/search/result.html?kwType="+kwType+"&jobLocIds="+jobLocIds+"&jobLocNames="+jobLocNames+"&keyword="+keyword+"&jobFun="+jobFun+"&jobFunNames="+jobFunNames+"&calling="+calling+"&callingNames="+callingNames+"&salaryId="+salaryId+"&sexId="+sexId+"&rewardId="+rewardId+"&eduId"+eduId;
                        }
                        ,onShow : function(s){
            ...
            ,catelogsClick : function(){
                var selector = new uiSelector({
                        ...
                        ,onSave:function(s){
                            ...
                            //
                            jobFun = s.OPTIONS.selectedItemsId;
                            jobFunNames = s.OPTIONS.selectedItemsText;
                            // window.location = "/search/result.html?kwType="+kwType+"&jobLocIds="+jobLocIds+"&jobLocNames="+jobLocNames+"&keyword="+keyword+"&jobFun="+jobFun+"&jobFunNames="+jobFunNames+"&calling="+calling+"&callingNames="+callingNames+"&salaryId="+salaryId+"&sexId="+sexId+"&rewardId="+rewardId+"&eduId"+eduId;
                        }
                        ,onShow : function(s){
