    ...
    out.initGetMore = function() {
        ...
        if( $moreBtn.length === 0 ) {
            ...
            $moreBtn.tap(function() {
                ...
                $.ajax({
                    type: 'GET',
                    url: '/touch/zph/dgut/getZphInfo.uhtml',
                    data: {
                        type: searchType,
                        para: searchPara,
                    ...
                    success: function(data) {
                        ...
                        var html = [];
                        html.push('<div id="page' + pageNumber + '" class="controller_page">第' + pageNumber + '页</div><ul>');
                        ...
                        for( var i = 0; i < len; i++ ) {
                            ...
                            for( var j = 1; j < 6; j++ ) {
                                ...
                                if( data.rows[i][loc].length > 0 ) {
                                    html.push('<dd>' + data.rows[i][loc] + '</dd>');
                                }
                            }
