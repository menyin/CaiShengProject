...
(function($) {
	var jobsort = function(element,opt) {
		...
		this._defaults ={
			url: '/jobsort/getjobsort/callback-callback-jobsort-',
			multipleUrl:'/jobsort/getjobsorts/callback-callback-jobsorts-',
			allSubUrl:'/jobsort/getsubjobsorts/callback-callback-jobsort-',
			/*
			url: '/api/jobclass.do?id=0',
			multipleUrl:'/api/jobclass.do?act=multiple&id=',
			allSubUrl:'/api/jobclass.do?id=',
			*/
			isLimit:false,
			max:5,
			tipClass:'tipClass',
