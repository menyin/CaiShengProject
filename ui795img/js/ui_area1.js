(function($){
	...
	area.Default = {
		provinceStructure:' <span class="drop addFstDrop formText"><b class="jpFntWes dropIco">&#xf0d7;</b>'+
						  ...
						  ' </div>'+
						  ' </span>',
		cityStructure:	'<span class="drop addSndDrop formText"><b class="jpFntWes dropIco">&#xf0d7;</b>'+
						...
						'</div>'+
						'</span> ',
        areaStructure:'<span class="drop addThrdDrop formText"><b class="jpFntWes dropIco">&#xf0d7;</b>'+
						...
						'</div>'+
						'</span>',
        tradingareaStructure:'<span class="drop addFourDrop formText"><b class="jpFntWes dropIco">&#xf0d7;</b>'+
		...
		provinceUrl:'/area/getarea/callback-callback',   //省／直辖市　ｕｒｌ地址
	    areaUrl:'/area/GetTopArea/callback-callback-areaid-',// 获取当前地区及父级地区信息url地址　　
		subAreaUrl:'/area/getarea/callback-callback-areaid-',     // 获取子级地区信息Url地址
		showLevel:2,
